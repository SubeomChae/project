 ...
 * Generated at: 2019-09-20 07:43:30 UTC
...
public final class lon12001_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(!box.get("ajax_yn").equals("Y")) { 
      ...
      out.write("\t\tajaxReplaceForm(\"lon12001_list.do\", \"#main\", \"#divListData\", function() {\r\n");
      ...
      out.write("\t\tvar pageUrl = 'lon12002_list.do?loan_no='+loan_no;\r\n");
 ...
 if(!box.get("loan_no").equals("")) { 
      ...
      out.write("\r\n");
      out.write("\t<h1 class=\"page-title\">대부금 일시(중도/퇴직)상환</h1>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\" class=\"form-control\" style=\"width:120px;ime-mode:active;\" onkeydown=\"if(event.keyCode == 13) goSearch('');\"></td>\r\n");
      out.write("\t\t\t\t<td class=\"td-head\">진행상태</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<select name=\"finish_flag\" title=\"진행상태\" class=\"bs-select form-control\" style=\"width:90px\">\r\n");
      out.write("\t\t\t            <option value='1' ");
      out.print(box.get("finish_flag").equals("1")?"selected":"");
      out.write(">진행중</option>\r\n");
      out.write("\t\t\t            <option value='2' ");
      out.print(box.get("finish_flag").equals("2")?"selected":"");
