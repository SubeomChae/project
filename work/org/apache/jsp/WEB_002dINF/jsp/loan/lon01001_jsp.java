 ...
 * Generated at: 2019-09-16 09:18:52 UTC
...
public final class lon01001_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(!box.get("ajax_yn").equals("Y")) { 
      ...
      out.write("\tfunction goSearch(loan_no) {\r\n");
      out.write("\t\tdocument.main.page_count.value = '';\r\n");
      out.write("\t\tajaxReplaceForm(\"lon01001_list.do\", \"#main\", \"#divListData\", function() {\r\n");
      out.write("\t\t\tif(loan_no == '') {\r\n");
      out.write("\t\t\t\tif ($(\"tr[id='tr_0']\").attr(\"loan_no\") != undefined) {\r\n");
      out.write("\t\t\t\t\tgoDetail($(\"tr[id='tr_0']\").attr(\"loan_no\"));\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t}else {\r\n");
      out.write("\t\t\t\tgoDetail(loan_no); \r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\tajaxReplaceForm(\"lon01001_list.do\", \"#main\", \"#divListData\", function() {\r\n");
      out.write("\t\t\tvar loan_no = $(\"tr[id='tr_0']\").attr(\"loan_no\");\r\n");
      out.write("\t\t\tif(loan_no != undefined) { goDetail(loan_no); }\r\n");
      out.write("\t\t\tfixTableHeader(\"MyTable\");\r\n");
      out.write("\t\t});\r\n");
      ...
      out.write("\t\tajaxReplaceForm(\"lon01003_edit.do\", \"#main\", \"#divFrame\");\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction goDetail(loan_no) {\r\n");
      out.write("\t\t$(\"tr[id^='tr_']\").removeClass(\"bg-yellow\");\r\n");
      out.write("\t\tif(loan_no != '') { $(\"tr[loan_no='\"+loan_no+\"']\").addClass(\"bg-yellow\"); }\r\n");
      out.write("\t\tvar pageUrl = 'lon01002_select.do?loan_no='+loan_no;\r\n");
 ...
 if(rsWp.get("loan_no",i).equals(box.get("loan_no"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t$(\"tr[loan_no='\"+loan_no+\"']\").addClass(\"bg-yellow\");\r\n");
      out.write("\t\t  \t\tgoDetail('");
      ...
      out.write("\r\n");
      out.write("\t<h1 class=\"page-title\">대부금 신청</h1>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-inline\">\r\n");
      out.write("\t\t\t\t\t\t<select name=\"pro_status\" title=\"진행상태\" class=\"bs-select form-control\" style=\"width:140px\">\r\n");
      out.write("\t\t\t\t\t\t\t<option value=''>전체</option>\r\n");
      out.write("\t\t\t\t\t\t\t");
      out.print(CodeUtil.optList("PR_COMTB_CODE02_LIST","LISTCODE",box.get("pro_status"),"lon_pro_status","","","",""));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t</select>\r\n");
      ...
      out.write("\r\n");
      out.write("\t<div>\r\n");
      out.write("\t\t<span style=\"color:#01a1db;\">대부일자를 클릭</span>하면 해당 대부금 신청 세부내역을 조회할 수 있습니다.\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t<thead>\t\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th><a href=\"javascript:goSort('t1.loan_ymd')\">대부일자</a></th>\r\n");
      out.write("\t\t\t\t\t\t\t<th><a href=\"javascript:goSort('t2.empl_nm')\">성명</a></th>\r\n");
      out.write("\t\t\t\t\t\t\t<th><a href=\"javascript:goSort('t1.bugt_cd')\">대부종류</a></th>\r\n");
      out.write("\t\t\t\t\t\t\t<th><a href=\"javascript:goSort('t1.loan_amt')\">대부금액</a></th>\r\n");
      out.write("\t\t\t\t\t\t\t<th><a href=\"javascript:goSort('t1.sign_status, t1.finish_flag')\">상태</a></th>\r\n");
      out.write("\t\t          \t\t</tr>\r\n");
      out.write("\t\t          \t</thead>\r\n");
      out.write("\t\t          \t<tbody>\r\n");
      out.write("\t\t\t\t\t");
