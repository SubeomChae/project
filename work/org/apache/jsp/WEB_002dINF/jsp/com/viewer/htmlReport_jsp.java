 ...
 * Generated at: 2019-09-20 06:42:04 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.jsp.com.viewer;
...
return;
	...
	Box msgBox = CodeUtil.getRsBox("PR_REPORT_SQL", "SIGNLINE", obox.get("msg_type"), "", msg_no,"","", uSesEnt.dbo);
      ...
      out.write("\t\t\r\n");
      out.write("\t    if (isIE) { \r\n");
      out.write("\t    \tvar ieActiveX = \"<OBJECT id=IEPageSetupX classid='clsid:41C5BC45-1BE8-42C5-AD9F-495D6C8D7586' codebase='/com/htmlReport/IEPageSetupX.cab#version=1,4,0,3' width=0 height=0> \"\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t+ \"<BR>  인쇄 여백제어 컨트롤이 설치되지 않았습니다.  <BR>  <a href='/com/htmlReport/IEPageSetupX.exe'><font color=red>이곳</font></a>을 클릭하여 수동으로 설치하시기 바랍니다.  </FONT> \"\r\n");
      out.write("\t\t\t\t\t\t\t+ \"</div> \"\r\n");
      out.write("\t\t\t\t\t\t\t+ \"</OBJECT> \"\r\n");
