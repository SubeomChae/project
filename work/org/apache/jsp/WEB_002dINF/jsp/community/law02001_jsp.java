 ...
 * Generated at: 2019-09-03 04:09:02 UTC
...
public final class law02001_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<!-- 자료실(정관, 운영규정) -->\r\n");
 if(!box.get("ajax_yn").equals("Y")) { 
      out.write("\r\n");
      out.write("<script language=\"javascript\">\r\n");
      out.write("\tfunction goDetail(chg_seq) {\r\n");
      out.write("\t\t$(\"tr[id^='tr_']\").removeClass(\"bg-yellow\");\r\n");
      out.write("\t\tif(chg_seq != '') { $(\"tr[chg_seq='\"+chg_seq+\"']\").addClass(\"bg-yellow\"); }\r\n");
      out.write("\t\tvar pageUrl = '/community/fd/law02002_select.do?law_id=");
      out.print(box.get("law_id"));
      out.write("&chg_seq=' + chg_seq;\r\n");
 ...
 if(rsWp.getLength() > 0) { 
      ...
      out.print(box.get("law_id"));
      out.write("\">\r\n");
      out.write("<input type=\"hidden\" name=\"law_class\" \tvalue=\"");
      out.print(obox.get("law_class"));
      out.write("\">\r\n");
      ...
      out.write("\t\t\t\t<div class=\"table-scrollable scrollOptionY\" style=\"width:100%; height:calc(100vh - 130px);\">\r\n");
 ...
 for(int i=0; i < rsWp.getLength(); i++) {	
      ...
      out.print(i);
      out.write("\" chg_seq=");
      out.print(rsWp.get("chg_seq",i));
      out.write(" style=\"cursor:pointer\" onClick=\"goDetail('");
      out.print(rsWp.get("chg_seq",i));
      out.write("')\"> \r\n");
      out.write("\t\t\t\t\t\t\t\t<td>");
      out.print(String.valueOf(rsWp.getLength()-i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>");
      out.print(rsWp.get("chg_ymd",i,Box.DEF_DATE_FMT));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td>");
      out.print(rsWp.get("sys_upd_nm",i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t");
 } 
 ...
 if(rsWp.getLength() == 0) { 
      ...
      out.write("\t\t\t\t<iframe id=\"ifrm\" name=\"ifrm\" marginwidth=\"0\" frameborder=\"0\" width=\"100%\" height=\"600\" scrolling=\"no\"></iframe>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\t\r\n");
      out.write("\t</div>\r\n");
      out.write("</form>");
