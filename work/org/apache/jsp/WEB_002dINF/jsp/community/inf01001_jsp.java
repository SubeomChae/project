 ...
 * Generated at: 2019-08-29 04:10:57 UTC
...
public final class inf01001_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(!box.get("ajax_yn").equals("Y")) { 
      ...
      out.write("\t\t\tajaxReplaceForm(\"inf01001_list.do\", \"#main\", \"#divListData\", function() {\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction goDetail(inform_no) {\r\n");
      out.write("\t\tdocument.main.action = 'inf01002_select.do?inform_no='+inform_no;\r\n");
      ...
      out.write("\t\t\t\t\t<select name=\"search_key\" class=\"bs-select form-control\" style=\"width:130px\">\r\n");
      ...
      out.write("\" class=\"form-control\" style=\"width:200px; ime-mode:active;\" onkeydown=\"if(event.keyCode == 13){goSearch(); return false;}\">\r\n");
 ...
 if(uSesEnt.use_auth.startsWith("S")) { 
      ...
      out.write("\t\t  \t<span style=\"color:#01a1db;\">제목을 클릭</span>하면 공지사항 세부내용을 검색할 수 있습니다.\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\t\r\n");
      out.write("\t\r\n");
 ...
 for(int i=0; i < rsWp.getLength(); i++) { 
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"t-left\"><a href=\"javascript:goDetail('");
      out.print(rsWp.get("inform_no",i));
      out.write("');\">");
      out.print(StringUtil.getReplaceSpecialCharacters(rsWp.get("inform_head",i)));
      out.write("</a>\r\n");
      out.write("\t\t\t\t\t\t");
if(DateUtil.dayDiff(rsWp.get("sys_reg_date",i),DateUtil.toString("yyyyMMdd")) <= 7) {
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("inquiry_cnt",i,Box.THOUSAND_COMMA));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("due_ymd",i,Box.DEF_DATE_FMT));
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t");
 } 
 ...
 if(rsWp.getLength() == 0) { 
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<tr><td colspan=\"6\" align=\"t-center\">등록된 자료가 없습니다.</td></tr>\r\n");
      out.write("\t\t\t");
 } 
      out.write("\r\n");
      out.write("\t\t\t</tbody>\t\t   \t  \r\n");
