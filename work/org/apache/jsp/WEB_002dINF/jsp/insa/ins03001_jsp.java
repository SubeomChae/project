 ...
 * Generated at: 2019-09-16 06:46:38 UTC
...
public final class ins03001_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\tfunction goView(family_id) {\r\n");
      out.write("\t\t$(\"tr[id^='tr_']\").removeClass(\"bg-yellow\");\r\n");
      out.write("\t\tif(family_id != '') { $(\"tr[family_id='\"+family_id+\"']\").addClass(\"bg-yellow\"); }\r\n");
      out.write("\t\tvar param = \"empl_no=");
      out.print(box.get("empl_no"));
      out.write("&family_id=\"+family_id\r\n");
      out.write("\t\tajaxReplace(\"ins03002_edit.do?actionType=view\", param, \"#dialog-form\", function(rtn) {\r\n");
      ...
      out.print(box.get("empl_no"));
      out.write("\";\r\n");
      out.write("\t\tajaxReplace(\"ins03002_edit.do?actionType=write\", param, \"#dialog-form\", function(rtn) {\r\n");
      out.write("\t\t\t$('#dialog-form').modal('show');\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("<form id=\"listForm\" name=\"listForm\" method=\"post\" action=\"\" class=\"fType\" style=\"margin:0px\">\r\n");
      ...
      out.write("\">\r\n");
      out.write("\r\n");
      out.write("\t<div class=\"table-scrollable scrollOptionY\" style=\"height:100%;\">\r\n");
 ...
 if(rsWp.getLength() == 0) { 
      ...
      out.print(i);
      out.write("\" family_id=\"");
      out.print(rsWp.get("family_id",i));
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("school_career_nm",i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("work_nm",i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("work_place",i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("buyang_yn",i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("living_yn",i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t");
 } 
