 ...
 * Generated at: 2019-09-26 01:08:56 UTC
...
public final class ins02001_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\tfunction goView(school_seq) {\r\n");
      out.write("\t\t$(\"tr[id^='tr_']\").removeClass(\"bg-yellow\");\r\n");
      out.write("\t\tif(school_seq != '') { $(\"tr[school_seq='\"+school_seq+\"']\").addClass(\"bg-yellow\"); }\r\n");
      out.write("\t\tvar param = \"empl_no=");
      out.print(box.get("empl_no"));
      out.write("&school_seq=\"+school_seq\r\n");
      out.write("\t\tajaxReplace(\"ins02002_edit.do?actionType=view\", param, \"#dialog-form\", function(rtn) {\r\n");
      ...
      out.print(box.get("empl_no"));
      out.write("\";\r\n");
      out.write("\t\tajaxReplace(\"ins02002_edit.do?actionType=write\", param, \"#dialog-form\", function(rtn) {\r\n");
      out.write("\t\t\t$('#dialog-form').modal('show');\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("<form id=\"listForm\" name=\"listForm\" method=\"post\" action=\"\" class=\"fType\">\r\n");
      ...
      out.write("\r\n");
      out.write("\t<div class=\"table-scrollable scrollOptionY\" style=\"width: 100%;height:100%;\">\r\n");
      ...
      out.write("\t\t\t\t\t<th>No</th>\r\n");
      out.write("\t\t\t\t\t<th>학교명</th>\r\n");
      out.write("\t\t\t\t\t<th>입학년도</th>\r\n");
      out.write("\t\t\t\t\t<th>졸업년도</th>\r\n");
      out.write("\t\t\t\t\t<th>구분</th>\r\n");
      out.write("\t\t\t\t\t<th>전공</th>\r\n");
      out.write("\t\t\t\t\t<th>학위</th>\r\n");
      out.write("\t\t\t\t\t<th>소재지</th>\r\n");
 ...
 if(rsWp.getLength() == 0) { 
      out.write("\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<td colspan=\"8\">등록된 자료가 없습니다.</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t");
 }else { 			
      ...
      out.write("\t\t\t\t<tr id=\"tr_");
      out.print(i);
      out.write("\" school_seq=\"");
      out.print(rsWp.get("school_seq",i));
      out.write("\" class=\"odd gradeX\" style=\"cursor:pointer\" onClick=\"goView('");
      out.print(rsWp.get("school_seq",i));
      out.write("')\">\r\n");
      out.write("\t\t\t\t\t<td>");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("graduate_ymd",i,Box.DEF_DATE_FMT));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("complete_flag_nm",i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("major_nm",i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("hakwi_nm",i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("school_loc",i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t");
 } 
