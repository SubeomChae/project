 ...
 * Generated at: 2019-09-26 01:08:57 UTC
...
public final class ins02002_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	RsWrapper codeWp = CodeUtil.getRsWrapper("PR_COMTB_CODE02_LIST","MULTCODE", "", "hakwi_cd|complete_flag|","","","",""); 
      out.write("\r\n");
      out.write("<!-- 학력사항 세부정보 등록  -->\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("\tfunction goSave() {\r\n");
      out.write("\t\tif(formValidate(\"#saveForm\")) { \r\n");
      out.write("\t\t\tif(confirm(\"저장하시겠습니까?\")) {\r\n");
      out.write("\t\t\t\tdocument.saveForm.actionType.value = isEmpty(document.saveForm.school_seq) ? 'INSERT' : 'UPDATE';\r\n");
      out.write("\t\t\t\tremoveMask(\"#saveForm\");\r\n");
      out.write("\t\t\t\tajaxSubmitForm(\"ins02002_update.do\",\"#saveForm\", function(rtn) {\r\n");
      out.write("\t\t\t\t\tif(rtn.isOk == \"Y\") {\r\n");
      out.write("\t\t\t\t\t\t$('#dialog-form').modal('hide');\r\n");
      out.write("\t\t\t\t\t\treturnFormSubmit(document.saveForm, 'ins02001_list.do');\r\n");
      out.write("\t\t\t\t\t}else {\r\n");
      ...
      out.write("\t\t\tajaxSubmitForm(\"ins02002_delete.do\",\"#saveForm\", function(rtn) {\r\n");
      out.write("\t\t\t\tif(rtn.isOk == \"Y\") {\r\n");
      out.write("\t\t\t\t\t$('#dialog-form').modal('hide');\r\n");
      out.write("\t\t\t\t\treturnFormSubmit(document.saveForm, 'ins02001_list.do');\r\n");
      out.write("\t\t\t\t}else {\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction changeCompleteFlag(complete_flag) {\r\n");
      out.write("\t\tchangeObjectProperty(document.saveForm.graduate_ymd, (complete_flag == '5') ? 'enabled' : 'required');\r\n");
      out.write("\t}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t<h4 class=\"modal-title\">학력사항 세부정보</h4>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\">\r\n");
      out.write("\t\t\t<input type=\"hidden\" name=\"school_seq\"\tvalue=\"");
      out.print(box.get("school_seq"));
      out.write("\">\t\t\t\r\n");
      ...
      out.write("\" maxlength=\"10\" title=\"학교명\" class=\"form-control required\" style=\"width:80px\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t<th>학위</th>\r\n");
      out.write("\t\t\t\t\t\t<td class=\"t-left\">\r\n");
      out.write("\t\t\t\t\t\t\t<select name=\"hakwi_cd\" title=\"학위\" class=\"bs-select form-control\" style=\"width:90px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<option value=''>선택</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
      out.print(CodeUtil.optList(codeWp, "hakwi_cd",obox.get("hakwi_cd")));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\" maxlength=\"8\" title=\"입학년도\" class=\"form-control required tYMD\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-btn\"><button class=\"btn dark\" type=\"button\"><i class=\"fa fa-calendar\"></i></button></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<span> ~ </span>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group input-medium date date-picker\" data-date=\"");
      out.print(obox.get("graduate_ymd",Box.DEF_DATE_FMT));
      out.write("\" data-date-format=\"yyyy-mm-dd\" data-date-viewmode=\"years\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"text\" id=\"graduate_ymd\" name=\"graduate_ymd\" value=\"");
      out.print(obox.get("graduate_ymd"));
      out.write("\" maxlength=\"8\" title=\"졸업년도\" class=\"form-control tYMD\" ");
if(!obox.get("complete_flag").equals("5")){
      out.write("required");
}
      out.write(">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<span class=\"input-group-btn\"><button class=\"btn dark\" type=\"button\"><i class=\"fa fa-calendar\"></i></button></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<select name=\"complete_flag\" title=\"졸업구분\" class=\"bs-select form-control\" style=\"width:70px\" onChange=\"changeObjectProperty(document.saveForm.graduate_ymd, this.value=='5'?'enabled':'required');\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t");
      out.print(CodeUtil.optList(codeWp, "complete_flag",obox.get("complete_flag")));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      ...
      out.write("\" maxlength=\"20\" title=\"전공\" class='form-control' style=\"width:120px\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<th>소재지</th>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"3\" class=\"t-left\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"school_loc\" value=\"");
      out.print(obox.get("school_loc"));
      out.write("\" maxlength=\"50\" title=\"소재지\" class='form-control' style=\"width:100%\">\r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t</table>\r\n");
