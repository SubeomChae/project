 ...
 * Generated at: 2019-09-20 07:44:06 UTC
...
public final class rpt12001_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(!box.get("ajax_yn").equals("Y")) { 
      ...
      out.write("\t\t\tvar theURL = 'rpt12001_list.do';\r\n");
      out.write("\t\t\tif(gbn == 'E') { \r\n");
      ...
      out.write("<input type=\"hidden\" name=\"acct_cd_arr\" \tvalue=\"");
      out.print(box.get("acct_cd_arr"));
      out.write("\">\r\n");
      out.write("<input type=\"hidden\" name=\"excel_file_nm\" \tvalue=\"계정별잔액 증감현황\">\r\n");
      out.write("\r\n");
      out.write("\t<h1 class=\"page-title\">계정별잔액 증감현황</h1>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\t<td class=\"td-head\" width=\"11%\">기준년월</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<select name=\"std_year\" title=\"기준년도\" class=\"bs-select form-control\" style=\"width:70px;\">\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(DateUtil.getYearOptionTag(box.get("std_year"),"2010",DateUtil.nextYear(),"desc","년"));
      out.write("\r\n");
      out.write("\t\t\t\t\t</select> \r\n");
      out.write("\t\t\t\t\t<select name=\"std_month\" title=\"기준월\" class=\"bs-select form-control\" style=\"width:60px\" onChange=\"goSearch();\">\r\n");
      out.write("\t          \t\t\t");
      ...
      out.write("\" title=\"계정과목\" class=\"form-control\" style=\"width:180px;ime-mode:active;\" onKeyUp=\"document.main.acct_cd.value='';\" onkeydown=\"if(event.keyCode == 13) goSearch('N');\">\r\n");
 ...
 if(!box.get("excel_yn").equals("Y")) { 
      ...
      out.write("\t\t\t<span style=\"color:#01a1db;\">계정과목을 클릭</span>하면 보조부로 연결됩니다.\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.write("\t\t</span>\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<div id=\"divArea\" class=\"table-scrollable scrollOptionY\" style=\"height:");
      out.print(box.get("popup_yn").equals("Y") ? "650px" : "calc(100vh - 150px)");
      out.write("\">\r\n");
 } 
      out.write("\r\n");
...
if(!box.get("excel_yn").equals("Y")&&!rsWp.get("acct_cd",i).equals("z")){
      ...
      out.print(rsWp.get("pre_iwol_amt",i,Box.THOUSAND_COMMA));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"t-right\">");
      out.print(rsWp.get("cur_incr_amt",i,Box.THOUSAND_COMMA));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"t-right\">");
      out.print(rsWp.get("cur_decr_amt",i,Box.THOUSAND_COMMA));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"t-right\">");
      out.print(FormatUtil.insertComma(String.valueOf(rsWp.getLong("pre_iwol_amt",i)+rsWp.getLong("cur_incr_amt",i)-rsWp.getLong("cur_decr_amt",i))));
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\t\r\n");
      out.write("\t\t\t\t");
 } 
