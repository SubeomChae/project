 ...
 * Generated at: 2019-09-03 03:01:06 UTC
...
public final class rpt22001_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(!box.get("ajax_yn").equals("Y")) { 
      ...
      out.write("\t\t\tajaxReplaceForm(\"rpt22001_list.do\", \"#main\", \"#divListData\");\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction goCreate() {\r\n");
      out.write("\t\tif (formValidate(\"#main\")) {\r\n");
      out.write("\t\t\tif(confirm(document.main.std_year.value +'년도 재무제표 잔액데이터를 '+(parseInt(document.main.std_year.value)+1)+'년도 기초데이터로 이관하시겠습니까?')) {\r\n");
      out.write("\t\t\t\tremoveMask(\"#main\");\t\t\t\t\r\n");
      out.write("\t\t\t\tdocument.main.action = 'rpt22001_update.do';\r\n");
      ...
      out.write("\r\n");
      out.write("\t<h1 class=\"page-title\">재무제표 연이월</h1>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\t\t  \t<button type=\"button\" id=\"btnSearch\" class=\"btn btn-primary\" onclick=\"goSearch();\"><img src=\"/com/img/ico_btn_search.png\">검색</button>\r\n");
      out.write("\t\t\t  \t\t");
 if(uSesEnt.use_auth.equals("S2") || uSesEnt.use_auth.equals("SA")) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t  \t<button type=\"button\" id=\"btnSearch\" class=\"btn btn-primary\" onclick=\"goCreate();\">자료생성</button>\r\n");
      out.write("\t\t\t  \t\t");
 } 
      out.write("\r\n");
      out.write("\t\t\t  \t\t</span>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\r\n");
      out.write("\t<div class=\"table-top-guide marB5 marL5\">\r\n");
      out.write("\t\t다음은 ");
      out.print(box.get("std_year"));
      out.write("년도 기말 계정별 잔액현황입니다.&nbsp;&nbsp;<span style=\"color:#01a1db;\">[자료생성]버튼을 클릭</span>하면  ");
      out.print(box.getInt("std_year")+1);
      out.write("년 기초데이터로 생성되어 집니다.\r\n");
      out.write("\t</div>\t\r\n");
      out.write("\t\r\n");
 ...
 if(box.get("select_yn").equals("Y") && rsWp.getLength() == 0) { 
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td class=\"t-right\"\">");
      out.print(rsWp.get("cur_acum_amt",i,Box.THOUSAND_COMMA));
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\t\r\n");
      out.write("\t\t\t\t");
 } 
