 ...
 * Generated at: 2019-08-29 03:57:05 UTC
...
public final class bud01002_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\tdocument.viewForm.action = '/budget/fd/bud01003_edit.do';\r\n");
      ...
      out.write("\t\t\tajaxSubmitForm(\"bud01002_delete.do\",\"#viewForm\", function(rtn) {\r\n");
      ...
      out.write("\t\t\t<td width=\"26%\" style=\"padding-left:5px\"><b>");
      out.print(obox.get("bugt_cd"));
      out.write("</b></td>\r\n");
      out.write("\t\t\t<th>사업명</th>\r\n");
      out.write("\t\t\t<td width=\"38%\" style=\"padding-left:5px\">");
      ...
      out.print(obox.get("bugt_purpose",Box.MULTILINE_TEXT));
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr height=\"50\">\r\n");
      out.write("\t\t\t<th>지급기준</th>\r\n");
      out.write("\t\t\t<td colspan=\"3\" style=\"padding:5 5 5 5\">");
      out.print(obox.get("pay_guide",Box.MULTILINE_TEXT));
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t");
 if(obox.get("bugt_class").endsWith("L")){ 
      ...
      out.write("\t\t\t<td style=\"padding-left:5px\">");
      out.print(obox.get("refund_nm"));
      out.write("</td>\r\n");
      out.write("\t\t\t<th>이자계산 방식</th>\r\n");
      out.write("\t\t\t<td style=\"padding-left:5px\">");
      out.print(obox.get("calc_nm"));
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr height=\"28\">\r\n");
      out.write("\t\t\t<th>이자율</th>\r\n");
 ...
 if(rsWp.getLength() > 0) { 
      ...
      out.write("\t\t\t<div class=\"col-md-12 col-xs-12 col-sm-12 row-set-col\">\r\n");
      out.write("\t\t\t\t<table id=\"MyTable\" class=\"table table-striped table-bordered table-hover order-column table-cover\">\r\n");
      out.write("\t\t\t\t\t<colgroup>\r\n");
 ...
 if(rsWp.getLength() == 0) { 
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t    <td>");
      out.print(rsWp.get("use_yn",i).equals("N")?"아니오":"예");
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t");
 } 
