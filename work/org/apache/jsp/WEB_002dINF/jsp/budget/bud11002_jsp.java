 ...
 * Generated at: 2019-09-03 01:24:29 UTC
...
public final class bud11002_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<title>사업계획 계정과목코드</title>\r\n");
      out.write("\r\n");
      out.write("<script language=\"javascript\">\r\n");
      out.write("\tfunction goSearch() {\r\n");
      out.write("\t\tajaxReplaceForm(\"bud11002_list.do\", \"#main\", \"#divListData\",null);\r\n");
      ...
      out.write("\t\t\t\tajaxSubmitForm(\"bud11002_update.do\",\"#main\", function(rtn) {\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t$(function() {\r\n");
      out.write("\t\t$(\".page-logo-text\").html(\"사업계획 계정과목코드\");\r\n");
      out.write("\t\tfixTableHeader(\"MyTable\");\r\n");
      out.write("\t});\r\n");
      out.write("</script>\r\n");
      ...
      out.write("\t<div class=\"table-scrollable scrollOptionY\" style=\"height:420px\">\r\n");
      out.write("\t\t<table id=\"MyTable\" class=\"table table-view table-bordered\">\r\n");
      out.write("\t\t\t<thead>\r\n");
      out.write("\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t<th width=\"20%\">코드</th>\r\n");
      out.write("\t\t\t\t\t<th width=\"45%\">계정과목명</th>\r\n");
      out.write("\t\t\t\t\t<th width=\"25%\">계정분류</th>\r\n");
 ...
 if(rsWp.getLength() == 0) { 
      out.write("\r\n");
      out.write("\t\t\t\t<tr height=\"25\"><td colspan=\"4\">등록된 자료가 없습니다.</td></tr>\r\n");
      out.write("\t\t\t");
 }else {
      ...
      out.print((rsWp.get("acct_cd",i).length()-4)*10);
      out.write("px\">");
      ...
      out.write("\t\t\t\t\t\t\t<input type=\"checkbox\" name=\"acct_cd\" value=\"");
      out.print(rsWp.get("acct_cd",i));
      out.write('|');
      out.write('"');
      out.write(' ');
      out.print(rsWp.get("plan_yn",i).equals("Y")?"checked":"");
      out.write("><span/>\r\n");
      out.write("\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t</tr>\t\r\n");
