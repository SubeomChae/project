 ...
 * Generated at: 2019-09-26 04:23:04 UTC
...
public final class s00400_005fedit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	if(obox.get("sign_status").equals("") || obox.get("sign_status").equals("1") || obox.get("sign_status").equals("4")) { isEditable = true; }
      ...
      out.write("\t\t\t\tdocument.saveForm.data01.value = document.saveForm.course_nm.value;\r\n");
      out.write("\t\t\t\tdocument.saveForm.data02.value = document.saveForm.edu_org_nm.value;\r\n");
      out.write("\t\t\t\tdocument.saveForm.data03.value = document.saveForm.edu_org_tel1.value+'-'+document.saveForm.edu_org_tel2.value+'-'+document.saveForm.edu_org_tel3.value;\r\n");
      out.write("\t\t\t\tdocument.saveForm.data04.value = document.saveForm.edu_org_addr.value;\r\n");
      ...
      out.write("\t\t\t\tdocument.saveForm.data07.value = document.saveForm.edu_ilsu.value;\r\n");
      ...
      out.write("\t\tvar edu_ilsu = 0;\r\n");
      out.write("\t\tif(target.substring(0,9) == 'start_ymd') {\r\n");
      out.write("\t\t\tif(!isEmpty(document.saveForm.end_ymd)) {\r\n");
      out.write("\t\t\t\tedu_ilsu = getDayInterval(document.saveForm.start_ymd.value.replace(/-/g,\"\")+'000', document.saveForm.end_ymd.value.replace(/-/g,\"\")+'000') + 1;\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tdocument.saveForm.edu_ilsu.value = edu_ilsu;\r\n");
      out.write("\t\tformatMaskElm(document.saveForm.edu_ilsu);\r\n");
      out.write("\t}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
...
for(int i=1;i<=15;i++){
 ...
 if(uSesEnt.use_auth.startsWith("S")) { 
      ...
      out.write("\t\t\t\t<th>교육명</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"course_nm\" value=\"");
      out.print(obox.get("course_nm"));
      out.write("\" size=\"30\" title=\"교육명\" class=\"form-control required\" style=\"width:240px\">\t\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<th>교육비</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"use_amt\" value=\"");
      out.print(obox.get("use_amt"));
      out.write("\" size=\"13\" title=\"교육비\" class=\"form-control required tMONEY\" style=\"width:90px\" > 원\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\" maxlength=\"8\" title=\"교육일자(부터)\" class=\"form-control required tYMD\" onChange=\"calendarSettingPost('start_ymd')\">\r\n");
      ...
      out.write("\" maxlength=\"8\" title=\"교육일자(까지)\" class=\"form-control required tYMD\" onChange=\"calendarSettingPost('end_ymd')\">\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"input-group-btn\"><button class=\"btn dark\" type=\"button\"><i class=\"fa fa-calendar\"></i></button></span>\r\n");
      out.write("\t\t\t\t\t\t</div>&nbsp;까지&nbsp;\r\n");
      out.write("\t\t\t\t\t\t(교육일수 : <input type=\"text\" name=\"edu_ilsu\" value=\"");
      out.print(obox.get("edu_ilsu"));
      out.write("\" maxlength=\"3\" title=\"교육일수\" class=\"form-control required tMONEY\" style=\"width:35px\" readonly>&nbsp;일)\r\n");
      out.write("\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th width=\"15%\">교육기관</th>\r\n");
      out.write("\t\t\t\t<td width=\"35%\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"edu_org_nm\" value=\"");
      out.print(obox.get("edu_org_nm"));
      out.write("\" maxlength=\"50\" title=\"교육기관\" class=\"form-control required\" style=\"width:240px\">\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<th width=\"15%\">기관연락처</th>\r\n");
      out.write("\t\t\t\t<td width=\"35%\">\r\n");
      out.write("\t\t\t\t\t<select name=\"edu_org_tel1\" title=\"전화번호\" class=\"bs-select form-control\" style=\"width:65px\">\r\n");
      out.write("\t\t\t\t\t\t<option value=''>선택</option>\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(CodeUtil.optList(codeWp, "tel_no", StringUtil.arrayCol(obox.get("edu_org_tel"),1,"-")));
      out.write("\r\n");
      out.write("\t\t\t\t\t</select> - \r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"edu_org_tel2\" value=\"");
      out.print(StringUtil.arrayCol(obox.get("edu_org_tel"),2,"-"));
      out.write("\" maxlength=\"4\" title=\"전화번호\" class=\"form-control autoTab\" style=\"width:65px\"> - \r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"edu_org_tel3\" value=\"");
      out.print(StringUtil.arrayCol(obox.get("edu_org_tel"),3,"-"));
      out.write("\" maxlength=\"4\" title=\"전화번호\" class=\"form-control autoTab\" style=\"width:65px\">\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr> \r\n");
      ...
      out.write("\t\t\t\t<td colspan=\"3\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"edu_org_addr\" value=\"");
      out.print(obox.get("edu_org_addr"));
      out.write("\" maxlength=\"50\" title=\"기관주소\" class=\"form-control required\" style=\"width:400px\">\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\" maxlength=\"10\" title=\"신청금액\" class=\"form-control required tMONEY\" style=\"width:90px\" > 원\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\" maxlength=\"120\" class=\"form-control\" title=\"비고\" style=\"width:90%\">\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t");
