 ...
 * Generated at: 2019-09-26 04:22:39 UTC
...
public final class s00100_005fedit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	if(obox.get("sign_status").equals("") || obox.get("sign_status").equals("1") || obox.get("sign_status").equals("4")) { isEditable = true; }
      ...
      out.write("\t\t\t\tdocument.saveForm.data04.value = document.saveForm.cong_class.value;\r\n");
      ...
      out.write("\t\t\t\tdocument.saveForm.data07.value = document.saveForm.cong_place.value;\r\n");
      out.write("\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tvar congWp = new Array();\r\n");
	...
	for(int i=0; i < congWp.getLength(); i++) { 
      ...
      out.print(i);
      out.write("] = '");
      out.print(congWp.get("code1",i));
      out.write('|');
      out.print(congWp.get("code2",i));
      out.write('|');
      out.print(congWp.get("data5",i));
      out.write("';\r\n");
	} 
      out.write("\t\t\t\t  \r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\tautoCongAmt();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction autoCongAmt() {\r\n");
      ...
      out.write("\t\t\t\t_f_format(document.saveForm.apply_amt);\r\n");
      out.write("\t\t\t\tbreak;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\t\tdocument.saveForm.end_ymd.value = document.saveForm.start_ymd.value.replace(/-/g,\"\");\r\n");
      out.write("\t\t\t_f_format(document.saveForm.end_ymd);\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
...
for(int i=1;i<=15;i++){
 ...
 if(uSesEnt.use_auth.startsWith("S")) { 
      ...
      out.write("\t<table class=\"table table-view table-bordered table-cover marB5\">\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th width=\"15%\">경조구분</th>\r\n");
      out.write("\t\t\t<td width=\"35%\">\r\n");
      out.write("\t\t\t\t<select name=\"cong_class\" title=\"경조구분\" class=\"bs-select form-control required\" style=\"width:117px\" onChange=\"autoCongAmt()\">\r\n");
      out.write("\t\t\t\t\t<option value=''>선택</option>\r\n");
      out.write("\t\t\t\t\t");
      out.print(CodeUtil.optList(codeWp, "cong_class", obox.get("cong_class")));
      out.write("\r\n");
      out.write("\t\t\t\t</select>\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<th width=\"15%\">대상자</th>\r\n");
      out.write("\t\t\t<td width=\"35%\">\r\n");
      out.write("\t\t\t\t<select name=\"family_id\" class=\"bs-select form-control required\" title=\"대상자 선택\" style=\"width:117px\" onChange=\"changeFamilyId(this.value)\">\r\n");
      out.write("\t\t\t\t\t<option value=''>:: 선택 ::</option>\r\n");
      out.write("\t\t\t\t");
	RsWrapper familyWp = CodeUtil.getRsWrapper("PR_INSTB_EMPL12_LIST","LISTCODE", "", obox.get("empl_no"),"00","","","",uSesEnt.dbo);
      ...
      out.write("\" maxlength=\"8\" title=\"경조기간(부터)\" class=\"form-control required tYMD\">\r\n");
      ...
      out.write("\" maxlength=\"8\" title=\"경조기간(까지)\" class=\"form-control required tYMD\">\r\n");
      out.write("\t\t\t\t\t\t<span class=\"input-group-btn\"><button class=\"btn dark\" type=\"button\"><i class=\"fa fa-calendar\"></i></button></span>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t<td colspan=\"3\">\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"cong_place\" value=\"");
      out.print(obox.get("cong_place",Box.SPECIAL_CHAR));
      out.write("\" title=\"경조장소\" class=\"form-control required\" style=\"width:140px\">\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      ...
      out.write("\" title=\"신청금액\" class=\"form-control required tMONEY\" style=\"width:100px\">&nbsp;원\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      ...
      out.write("\" maxlength=\"120\" title=\"비고\" class=\"form-control\" style=\"width:96%\">\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t");
