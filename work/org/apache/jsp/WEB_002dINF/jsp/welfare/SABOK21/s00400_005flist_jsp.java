...
public final class s00400_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(rsWp.get("apply_no",i).equals(box.get("apply_no"))) { 
      ...
      out.write("\t<h1 class=\"page-title\">자기개발비 신청</h1>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t<span style=\"color:#01a1db;\">신청일자를 클릭</span>하면 해당 자기개발비 신청 세부내역을 조회할 수 있습니다.\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<th><a href=\"javascript:goSort('t1.data01')\">교육명</a></th>\r\n");
      out.write("\t\t\t\t\t\t\t<th><a href=\"javascript:goSort('t4.sign_status')\">상태</a></ths>\r\n");
      out.write("\t\t          \t\t</tr>\r\n");
      out.write("\t          \t\t</thead>\r\n");
      out.write("\t          \t\t<tbody>\r\n");
      out.write("\t\t\t\t\t");
