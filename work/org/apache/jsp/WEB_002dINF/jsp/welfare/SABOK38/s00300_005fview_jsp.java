 ...
 * Generated at: 2019-09-26 05:10:41 UTC
...
public final class s00300_005fview_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(box.get("popup_yn").equals("Y")) { 
      out.write("\r\n");
      out.write("\t\t\t$(\".page-logo-text\").html(\"장학금 신청서 조회\");\t\r\n");
      out.write("\t\t");
 } 
      out.write("\r\n");
      out.write("\t});\r\n");
...
if(!obox.get("msg_no").equals("")){
 ...
 if(isEditable) { 
      ...
      out.write("\">\r\n");
      out.write("<input type=\"hidden\" name=\"subject\" \t\tvalue=\"장학금 신청(");
      out.print(obox.get("empl_nm"));
      out.write(")\">\r\n");
