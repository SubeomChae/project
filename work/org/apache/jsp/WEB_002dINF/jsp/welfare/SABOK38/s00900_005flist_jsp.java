 ...
 * Generated at: 2019-09-26 05:11:17 UTC
...
return;
 ...
 if(rsWp.get("apply_no",i).equals(box.get("apply_no"))) { 
      ...
      out.write("\t\r\n");
      out.write("\t<h1 class=\"page-title\">양육비 신청</h1>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<div class=\"form-inline\">\r\n");
      out.write("\t\t\t\t\t\t<select name=\"sign_status\" title=\"결재상태\" class=\"bs-select form-control\" style=\"width:140px\">\r\n");
      ...
      out.write("\t\t<span style=\"color:#01a1db;\">대상자를 클릭</span>하면 해당 양육비 상세내역을 조회할 수 있습니다.\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t<th><a href=\"javascript:goSort('t1.apply_ymd')\" title=\"신청일순 정렬\">신청일자</a></th>\r\n");
      out.write("\t\t\t\t\t\t\t<th><a href=\"javascript:goSort('t1.data12')\" title=\"신청구분 정렬\">신청구분</a></th>\r\n");
      out.write("\t\t\t\t\t\t\t<th><a href=\"javascript:goSort('t3.dept_nm')\" title=\"부서명순 정렬\">부서명</a></th>\r\n");
      out.write("\t\t\t\t\t\t\t<th><a href=\"javascript:goSort('t2.empl_nm')\" title=\"성명순 정렬\">성명</a></th>\r\n");
 ...
 if(rsWp.getLength() == 0) { 
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"t-center\">");
      out.print(rsWp.get("data12",i));
      out.write('자');
      out.write('녀');
      out.write('(');
      out.print(rsWp.get("data13",i));
      out.write("세)</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t<td class=\"t-center\">");
