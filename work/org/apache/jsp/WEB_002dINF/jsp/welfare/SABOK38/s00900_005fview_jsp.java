 ...
 * Generated at: 2019-09-26 05:11:19 UTC
...
public final class s00900_005fview_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(box.get("popup_yn").equals("Y")) { 
      out.write("\r\n");
      out.write("\t\t\t$(\".page-logo-text\").html(\"양육비 신청서 조회\");\t\r\n");
      out.write("\t\t");
 } 
      out.write("\r\n");
      out.write("\t});\r\n");
      ...
      out.write("\t\t\t<td>");
      out.print(obox.get("data12"));
      out.write("</td>\r\n");
      out.write("\t\t\t<th>자녀나이</th>\r\n");
      out.write("\t\t\t<td>");
      out.print(obox.get("data13").equals("")?"":obox.get("data13")+" 세");
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
...
if(!obox.get("msg_no").equals("")){
 ...
 if(isEditable) { 
      ...
      out.write('\n');
      out.write("\r\n");
      out.write("\t\t\t<button type=\"button\" class=\"btn dark\" onClick=\"goRptViewer('WEB-INF/jsp/welfare/");
      out.print(uSesEnt.dbo);
      out.write("/report/s002PDF', '");
      out.print(box.get("apply_no"));
      ...
      out.write("\">\r\n");
      out.write("<input type=\"hidden\" name=\"subject\" \t\tvalue=\"양육비 신청(");
      out.print(obox.get("empl_nm"));
      out.write(")\">\r\n");
