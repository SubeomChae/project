 ...
 * Generated at: 2019-09-26 05:10:40 UTC
...
return;
	...
	if(obox.get("sign_status").equals("") || obox.get("sign_status").equals("1") || obox.get("sign_status").equals("4")) { isEditable = true; }
      ...
      out.write("\r\n");
      out.write("<!-- 장학금 신청서 작성 -->\r\n");
      out.write("<script language=\"javascript\">\r\n");
      out.write("\tfunction goSave() {\r\n");
      out.write("\t\tif (formValidate(\"#main\")) {\r\n");
      out.write("\t\t\tif(confirm('저장하시겠습니까?')) {\r\n");
      out.write("\t\t\t\tremoveMask(\"#main\");\r\n");
      out.write("\t\t\t\tdocument.main.data01.value = document.main.family_rel_cd.value;\r\n");
      out.write("\t\t\t\tdocument.main.data02.value = document.main.family_nm.value;\r\n");
      out.write("\t\t\t\tdocument.main.data03.value = document.main.family_reside_no.value;\r\n");
      out.write("\t\t\t\tdocument.main.data04.value = document.main.school_nm.value;\r\n");
      out.write("\t\t\t\tdocument.main.data05.value = document.main.school_flag.value;\r\n");
      out.write("\t\t\t\tdocument.main.data06.value = document.main.major_nm.value;\r\n");
      out.write("\t\t\t\tdocument.main.data07.value = document.main.school_year.value;\r\n");
      out.write("\t\t\t\tdocument.main.data08.value = document.main.school_term.value;\r\n");
      out.write("\t\t\t");
 if(uSesEnt.dbo.equals("SABOK26")) { 
      out.write("\r\n");
      out.write("\t\t\t\tdocument.main.data09.value = document.main.grade_score.value;\r\n");
      out.write("\t\t\t\tdocument.main.data10.value = document.main.pay_amt.value;\r\n");
      out.write("\t\t\t");
 } 
      out.write("\r\n");
      out.write("\t\t\t\t\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction change_family_id(family_id) {\r\n");
      out.write("\t\tif(family_id == '') { return; }\r\n");
      out.write("\t\tvar family_value = document.main.family_id.options[document.main.family_id.options.selectedIndex].title;\r\n");
      out.write("\t\tvar arr = family_value.split('|');\r\n");
      out.write("\t\tdocument.main.family_rel_cd.value = arr[0];\r\n");
      out.write("\t\tdocument.main.family_nm.value = arr[1];\r\n");
      out.write("\t\tdocument.main.family_reside_no.value = arr[2];\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
...
for(int i=1;i<=15;i++){
 ...
 if(uSesEnt.dbo.equals("SABOK26")) { 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<select name=\"school_flag\" title=\"학교\" class=\"form-control required\" style=\"width:100px\">\r\n");
      ...
      out.write("\" size=\"20\" maxlength=\"20\" class=\"form-control\" title=\"학과\" style=\"width:140px\">\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t\t<th width=\"15%\">대상자</th>\r\n");
      out.write("\t\t\t<td width=\"35%\">\r\n");
      out.write("\t\t\t\t<select name=\"family_id\" title=\"대상자 선택\" class=\"bs-select form-control required\" onChange=\"change_family_id(this.value)\">\r\n");
	...
	RsWrapper familyWp = CodeUtil.getRsWrapper("PR_INSTB_EMPL12_LIST","LISTCODE", "", obox.get("empl_no"),"00","","","",uSesEnt.dbo);
      ...
      out.write("\" size=\"13\" maxlength=\"10\" class=\"form-control required tMONEY\" class=\"required\" title=\"신청금액\" style=\"width:90px;\" > 원\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
