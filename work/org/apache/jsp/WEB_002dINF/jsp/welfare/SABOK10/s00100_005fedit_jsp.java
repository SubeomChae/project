 ...
 * Generated at: 2019-09-26 02:24:44 UTC
...
for(int i=1;i<=15;i++){
 ...
 if(uSesEnt.use_auth.startsWith("S")) { 
      ...
      out.write("\t\t\t<td width=\"35%\">\r\n");
      out.write("\t\t\t\t<select name=\"cong_class\" class=\"bs-select form-control required\" title=\"경조구분\" style=\"width:100px\" onChange=\"autoCongAmt()\">\r\n");
	...
	RsWrapper familyWp = CodeUtil.getRsWrapper("PR_INSTB_EMPL12_LIST","LISTCODE", "", obox.get("empl_no"),"00","","","",uSesEnt.dbo);
      ...
      out.write("\t\t\t<td colspan=\"3\"><input type=\"text\" name=\"cong_place\" value=\"");
      out.print(obox.get("cong_place"));
      out.write("\" size=\"50\" maxlength=\"50\" title=\"경조장소\" class=\"form-control required\" style=\"width:240px\"></td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      ...
      out.write("\t\t\t<td ><input type=\"text\" name=\"apply_amt\" value=\"");
      out.print(obox.get("apply_amt"));
      out.write("\" size=\"13\" maxlength=\"10\" class=\"form-control required tMONEY\" title=\"신청금액\" style=\"width:90px;border:1 solid gray\" > 원</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      ...
      out.write("\" size=\"10\" maxlength=\"15\" title=\"예금주\" class=\"form-control required\" style=\"width:60px\">\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th>비고</th>\r\n");
