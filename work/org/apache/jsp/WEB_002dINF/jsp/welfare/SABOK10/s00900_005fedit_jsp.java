 ...
 * Generated at: 2019-09-26 02:27:46 UTC
...
for(int i=1;i<=15;i++){
 ...
 if(uSesEnt.use_auth.startsWith("S")) { 
      ...
      out.write("\t\t\t<th>대상자</th>\r\n");
      out.write("\t\t\t<td colspan=\"3\">\r\n");
      out.write("\t\t\t\t<select name=\"family_id\" title=\"대상자 선택\" class=\"bs-select form-control required\" style=\"width:130px\" onChange=\"changeFamilyId(this.value)\">\r\n");
