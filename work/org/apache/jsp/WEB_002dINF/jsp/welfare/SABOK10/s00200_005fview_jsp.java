...
public final class s00200_005fview_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(box.get("popup_yn").equals("Y")) { 
      out.write("\r\n");
      out.write("\t\t\t$(\".page-logo-text\").html(\"의료비 신청서 조회\");\t\r\n");
      out.write("\t\t");
 } 
      out.write("\r\n");
      out.write("\t});\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("<form name=\"viewForm\" method=\"post\" action=\"\" class=\"fType\" enctype=\"multipart/form-data\" style=\"margin:0px\">\r\n");
 ...
 if(!uSesEnt.dbo.equals("SABOK26")) { 
      ...
      out.write("\t\t\t<td>");
      out.print(obox.get("medi_ymd",Box.DEF_DATE_FMT));
      out.write("</td>\r\n");
      out.write("\t\t");
 } 
      out.write("\r\n");
...
if(!obox.get("slip_no").equals("")) { 
 ...
 if(isEditable) { 
      ...
      out.write("/report/s002.jrf', 'P_PARAM01!SLP002,");
      out.print(box.get("apply_no"));
      ...
      out.write("\">\r\n");
      out.write("<input type=\"hidden\" name=\"subject\" \t\tvalue=\"의료비 신청(");
      out.print(obox.get("empl_nm"));
      out.write(")\">\r\n");
