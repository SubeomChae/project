...
public final class s00600_005fview_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(box.get("popup_yn").equals("Y")) { 
      out.write("\r\n");
      out.write("\t\t\t$(\".page-logo-text\").html(\"사내동호인회지원 신청서 조회\");\t\r\n");
      out.write("\t\t");
 } 
      out.write("\r\n");
      out.write("\t});\r\n");
...
if(!obox.get("end_ymd").equals(obox.get("start_ymd"))){
      ...
      out.write("\t\t\t<td colspan=\"3\">");
      out.print(obox.get("event_content",Box.MULTILINE_TEXT));
      out.write("</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
...
if(!obox.get("slip_no").equals("")) { 
 ...
 if(isEditable) { 
      ...
      out.write("/report/s006.jrf', 'P_PARAM01!SLP002,");
      out.print(box.get("apply_no"));
