 ...
 * Generated at: 2019-09-26 02:24:45 UTC
...
public final class s00100_005fview_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(box.get("popup_yn").equals("Y")) { 
      out.write("\r\n");
      out.write("\t\t\t$(\".page-logo-text\").html(\"경조금 신청서 조회\");\t\r\n");
      out.write("\t\t");
 } 
      out.write("\r\n");
      out.write("\t});\r\n");
      ...
      out.write("\t\t\t<td width=\"35%\">");
      out.print(obox.get("cong_class_nm"));
      out.write("</td>\r\n");
...
if(!obox.get("slip_no").equals("")) { 
 ...
 if(isEditable) { 
      ...
      out.write("\">\r\n");
      out.write("<input type=\"hidden\" name=\"subject\" \t\tvalue=\"경조금 신청(");
      out.print(obox.get("empl_nm"));
      out.write(")\">\r\n");
