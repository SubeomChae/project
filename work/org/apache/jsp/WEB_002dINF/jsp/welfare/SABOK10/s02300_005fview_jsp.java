...
public final class s02300_005fview_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(box.get("popup_yn").equals("Y")) { 
      out.write("\r\n");
      out.write("\t\t\t$(\".page-logo-text\").html(\"꽃바구니 지원 신청서 조회\");\t\r\n");
      out.write("\t\t");
 } 
      out.write("\r\n");
      out.write("\t});\r\n");
...
if(!obox.get("slip_no").equals("")) { 
 ...
 if(isEditable) { 
      ...
      out.write("/report/s023.jrf', 'P_PARAM01!SLP002,");
      out.print(box.get("apply_no"));
      ...
      out.write("\">\r\n");
      out.write("<input type=\"hidden\" name=\"subject\" \t\tvalue=\"꽃바구니 신청(");
      out.print(obox.get("empl_nm"));
      out.write(")\">\r\n");
