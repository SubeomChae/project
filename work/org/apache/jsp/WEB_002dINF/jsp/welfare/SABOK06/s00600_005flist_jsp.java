...
public final class s00600_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(rsWp.get("apply_no",i).equals(box.get("apply_no"))) { 
      ...
      out.write("\t<h1 class=\"page-title\">사내동호인회지원</h1>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<select name=\"sign_status\" class=\"bs-select form-control\" title=\"결재상태\" style=\"width:140px\">\r\n");
      ...
      out.write("\t\t<span style=\"color:#01a1db;\">신청일자를 클릭</span>하면 해당 사내동호인회 지원비 신청 세부내역을 조회할 수 있습니다.\r\n");
      out.write("\t</div>\r\n");
      out.write("        \t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<th><a href=\"javascript:goSort('t1.bugt_cd')\">동호인회</a></th>\r\n");
