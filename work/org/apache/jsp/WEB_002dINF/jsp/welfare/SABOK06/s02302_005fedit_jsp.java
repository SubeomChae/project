 ...
 * Generated at: 2019-09-26 02:14:55 UTC
...
public final class s02302_005fedit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	if(obox.get("sign_status").equals("") || obox.get("sign_status").equals("1") || obox.get("sign_status").equals("4")) { isEditable = true; }
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<title>꽃바구니 선물 신청서 작성</title>\r\n");
      out.write("\r\n");
...
for(int i=1;i<=15;i++){
 ...
 if(uSesEnt.use_auth.startsWith("S")) { 
      ...
      out.write("\t<table class=\"table table-view table-bordered table-cover marB5\">\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th style=\"width:15%\">신청일자</th>\r\n");
      out.write("\t\t\t<td>\r\n");
