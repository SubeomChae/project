 ...
 * Generated at: 2019-09-26 03:15:07 UTC
...
public final class s01800_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(rsWp.get("apply_no",i).equals(box.get("apply_no"))) { 
      ...
      out.write("\t<h1 class=\"page-title\">체육/문화활동비 신청</h1>\r\n");
      out.write("\r\n");
      ...
      out.write("  \t\t<span style=\"color:#01a1db;\">신청일자를 클릭</span>하면 해당 체육/문화활동비 신청 세부내역을 조회할 수 있습니다.\r\n");
      out.write("\t</div>\r\n");
 ...
 if(rsWp.getLength() == 0) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<tr height=\"25\"><td colspan=\"4\" class=\"t-center\">등록된 자료가 없습니다.</td></tr>\r\n");
      out.write("\t\t\t\t\t");
}else { 
						  for(int i=0; i < rsWp.getLength(); i++) { 
      out.write("\r\n");
