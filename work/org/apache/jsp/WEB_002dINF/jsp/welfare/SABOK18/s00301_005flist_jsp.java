...
public final class s00301_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(rsWp.get("apply_no",i).equals(box.get("apply_no"))) { 
      ...
      out.write("\r\n");
      out.write("\t<h1 class=\"page-title\">교육비 신청</h1>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<select name=\"sign_status\" title=\"결재상태\" class=\"bs-select form-control\" style=\"width:90px\">\r\n");
      ...
      out.write("  \t\t<span style=\"color:#01a1db;\">신청일자를 클릭</span>하면 해당 교육비 신청 세부내역을 조회할 수 있습니다.\r\n");
      out.write("\t</div>\r\n");
