 ...
 * Generated at: 2019-09-26 01:26:30 UTC
...
public final class s00307_005fview_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(box.get("popup_yn").equals("Y")) { 
      out.write("\r\n");
      out.write("\t\t\t$(\".page-logo-text\").html(\"학자금 신청서 조회(안양)\");\t\r\n");
      out.write("\t\t");
 } 
      out.write("\r\n");
      out.write("\t});\r\n");
...
if(!obox.get("school_term").equals("")){
      ...
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th width=\"15%\">전공</th>\r\n");
      out.write("\t\t\t<td width=\"35%\">");
      out.print(obox.get("major_nm"));
      out.write("</td>\r\n");
      out.write("\t\t\t<th width=\"15%\">자녀명</th>\r\n");
      out.write("\t\t\t<td width=\"35%\">");
...
if(!obox.get("msg_no").equals("")) { 
 ...
 if(obox.get("sign_status").equals("1")) { 
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<button type=\"button\" class=\"btn btn-primary btn-table\" onClick=\"goUbiViewer('WEB-INF/jsp/welfare/");
      out.print(box.get("dbo"));
      out.write("/report/s003.jrf', 'P_PARAM01!SLP002,");
      out.print(box.get("apply_no"));
