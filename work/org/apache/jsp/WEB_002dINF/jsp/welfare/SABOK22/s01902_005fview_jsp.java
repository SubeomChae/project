 ...
 * Generated at: 2019-09-26 04:35:39 UTC
...
public final class s01902_005fview_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(box.get("popup_yn").equals("Y")) { 
      out.write("\r\n");
      out.write("\t\t\t$(\".page-logo-text\").html(\"장기근속 신청서 조회(안양)\");\t\r\n");
      out.write("\t\t");
 } 
      out.write("\r\n");
      out.write("\t});\r\n");
...
if(!obox.get("msg_no").equals("")) { 
 ...
 if(isEditable) { 
      ...
      out.write("/report/s019.jrf', 'P_PARAM01!SLP002,");
      out.print(box.get("apply_no"));
      ...
      out.write("\">\r\n");
      out.write("<input type=\"hidden\" name=\"subject\" \t\tvalue=\"장기근속 신청(");
      out.print(obox.get("empl_nm"));
      out.write(")\">\r\n");
