 ...
 * Generated at: 2019-09-18 04:13:30 UTC
...
for(int i=1;i<=15;i++){
 ...
 if(uSesEnt.use_auth.startsWith("S")) { 
	...
	RsWrapper familyWp = CodeUtil.getRsWrapper("PR_INSTB_EMPL12_LIST","LISTCODE", "", obox.get("empl_no"),"00","","","",uSesEnt.dbo);
      ...
      out.write("\" title=\"경조장소\" class=\"form-control required\" style=\"width:150px\">\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
...
if(!obox.get("slip_no").equals("")) { 
      ...
      out.write("');\"><img src=\"/com/img/icon_zoom.gif\" align=\"absmiddle\" border=\"0\"></a>\r\n");
      out.write("\t\t\t\t");
 } 
      out.write("\r\n");
