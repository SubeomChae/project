 ...
 * Generated at: 2019-08-29 05:36:31 UTC
...
public final class s00600_005fedit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	if(obox.get("sign_status").equals("") || obox.get("sign_status").equals("1") || obox.get("sign_status").equals("4")) { isEditable = true; }
      ...
      out.write("\t\t\t\tdocument.saveForm.data01.value = document.saveForm.start_ymd.value;\r\n");
      out.write("\t\t\t\tdocument.saveForm.data02.value = document.saveForm.end_ymd.value;\r\n");
      out.write("\t\t\t\tdocument.saveForm.data03.value = document.saveForm.event_place.value;\r\n");
      out.write("\t\t\t\tdocument.saveForm.data04.value = document.saveForm.event_content.value;\r\n");
      out.write("\r\n");
...
for(int i=1;i<=15;i++){
 ...
 if(box.get("apply_no").equals("")) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t<select name=\"sub_cd\" title=\"동호인회\" class=\"bs-select form-control required\" style=\"width:120px\">\r\n");
      out.write("\t\t\t\t\t\t<option value=''>선택</option>\r\n");
      out.write("\t\t\t\t\t\t");
      out.print(CodeUtil.optList("PR_BUDTB_CODE01_LIST","LISTCODE",obox.get("bugt_cd"),"2",box.get("bugt_cd"),"","","",uSesEnt.dbo));
      out.write("\r\n");
      out.write("\t\t\t\t\t</select> \r\n");
      out.write("\t\t\t\t");
 }else { 
      ...
      out.write("\" maxlength=\"8\" title=\"행사일자(부터)\" class=\"form-control required tYMD\">\r\n");
      ...
      out.write("\" maxlength=\"8\" title=\"행사일자(까지)\" class=\"form-control required tYMD\">\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"input-group-btn\"><button class=\"btn dark\" type=\"button\"><i class=\"fa fa-calendar\"></i></button></span>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t</td>\r\n");
      ...
      out.write("\t\t\t\t<th>장소</th>\r\n");
      out.write("\t\t\t\t<td colspan=\"3\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"event_place\" value=\"");
      out.print(obox.get("event_place"));
      out.write("\" maxlength=\"50\" title=\"장소\" class=\"form-control required\" style=\"width:300px;ime-mode:active;\">\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr height=\"100\">\r\n");
      out.write("\t\t\t\t<th>행사내용</th>\r\n");
      out.write("\t\t\t\t<td colspan=\"3\">\r\n");
      out.write("\t\t\t\t\t<textarea name=\"event_content\" title=\"행사내용\" class=\"form-control required\" style=\"height:90px;width:100%;ime-mode:active;\">");
      out.print(obox.get("event_content"));
      out.write("</textarea>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\" maxlength=\"10\" title=\"신청금액\" class=\"bs-select form-control required tMONEY\" style=\"width:100px\"> 원\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>비고</th>\r\n");
