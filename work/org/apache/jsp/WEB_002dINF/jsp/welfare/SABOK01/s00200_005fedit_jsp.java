 ...
 * Generated at: 2019-09-26 01:20:54 UTC
...
public final class s00200_005fedit_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	if(obox.get("sign_status").equals("") || obox.get("sign_status").equals("1") || obox.get("sign_status").equals("4")) { isEditable = true; }
      ...
      out.write("\t\t\t\tdocument.saveForm.data04.value = document.saveForm.medi_org_nm.value;\r\n");
      out.write("\t\t\t");
 if(!uSesEnt.dbo.equals("SABOK26")) { 
      out.write("\r\n");
      out.write("\t\t\t\tdocument.saveForm.data05.value = document.saveForm.medi_org_addr.value;\r\n");
      out.write("\t\t\t\tdocument.saveForm.data07.value = document.saveForm.medi_ymd.value;\r\n");
      out.write("\t\t\t");
 } 
      out.write("\r\n");
      out.write("\t\t\t\tdocument.saveForm.data06.value = document.saveForm.disease_nm.value;\r\n");
      out.write("\t\t\t\tdocument.saveForm.data08.value = document.saveForm.start_ymd.value;\r\n");
      out.write("\t\t\t\tdocument.saveForm.data09.value = document.saveForm.end_ymd.value;\r\n");
      out.write("\t\t\t\tdocument.saveForm.data10.value = document.saveForm.inner_ilsu.value;\r\n");
      out.write("\t\t\t\tdocument.saveForm.data11.value = document.saveForm.use_amt.value;\r\n");
      out.write("\r\n");
      ...
      out.write("\t\tvar inner_ilsu = 0;\r\n");
      out.write("\t\tif(target.substring(0,9) == 'start_ymd') {\r\n");
      out.write("\t\t\tif(!isEmpty(document.saveForm.end_ymd)) {\r\n");
      out.write("\t\t\t\tinner_ilsu = getDayInterval(document.saveForm.start_ymd.value.replace(/-/g,\"\")+'000', document.saveForm.end_ymd.value.replace(/-/g,\"\")+'000') + 1;\r\n");
      out.write("\t\t\t}\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tdocument.saveForm.inner_ilsu.value = inner_ilsu;\r\n");
      out.write("\t\tformatMaskElm(document.saveForm.inner_ilsu);\r\n");
      out.write("\t}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
...
for(int i=1;i<=15;i++){
 ...
 if(uSesEnt.dbo.equals("SABOK26")) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t<select name=\"family_rel_cd\" title=\"가족관계\" class=\"bs-select form-control required\" style=\"width:117px\">\r\n");
      out.write("\t\t\t\t\t\t<option value=''>:: 선택 ::</option>\r\n");
      out.write("\t\t\t\t\t\t<option value='00' ");
      out.print(obox.get("family_rel_cd").equals("00")?"selected":"");
      out.write(">본인</option>\r\n");
      out.write("\t\t\t\t\t\t<option value='30' ");
      out.print(obox.get("family_rel_cd").equals("30")?"selected":"");
      out.write(">배우자</option>\r\n");
	...
	RsWrapper familyWp = CodeUtil.getRsWrapper("PR_INSTB_EMPL12_LIST","LISTCODE", "", obox.get("empl_no"),"00","","","",uSesEnt.dbo);
      ...
      out.write("\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<th width=\"15%\">질환명</th>\r\n");
      out.write("\t\t\t\t<td width=\"35%\">\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"disease_nm\" value=\"");
      out.print(obox.get("disease_nm"));
      out.write("\" maxlength=\"50\" title=\"질환명\" class=\"form-control\" style=\"width:90%\">\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>의료기관</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"medi_org_nm\" value=\"");
      out.print(obox.get("medi_org_nm"));
      out.write("\" maxlength=\"50\" title=\"의료기관명\" class=\"form-control\" style=\"width:90%;\">\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t");
 if(!uSesEnt.dbo.equals("SABOK26")) { 
      out.write("\r\n");
      out.write("\t\t\t\t<th>소재지</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"medi_org_addr\" value=\"");
      out.print(obox.get("medi_org_addr"));
      out.write("\" maxlength=\"50\" title=\"의료기관 소재지\" class=\"form-control\" style=\"width:90%;\">\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>진료일자</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t\t<input type=\"text\" name=\"medi_ymd\" value=\"");
      out.print(obox.get("medi_ymd"));
      ...
      out.write("\r\n");
      out.write("\t\t\t\t<th>사용금액</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"use_amt\" value=\"");
      out.print(obox.get("use_amt"));
      out.write("\" maxlength=\"10\" title=\"사용금액\" class=\"form-control tMONEY\" style=\"width:70px\">&nbsp;원\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t");
 if(uSesEnt.corp_cd.equals("SABOK10")) { 
      ...
      out.print(obox.get("inner_start_ymd",Box.DEF_DATE_FMT));
      out.write("\" data-date-format=\"yyyy-mm-dd\" data-date-viewmode=\"years\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"start_ymd\" value=\"");
      out.print(obox.get("inner_start_ymd"));
      out.write("\" maxlength=\"8\" title=\"입원기간(부터)\" class=\"form-control tYMD\" onchange=\"calendarSettingPost('start_ymd')\">\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"input-group-btn\"><button class=\"btn dark\" type=\"button\"><i class=\"fa fa-calendar\"></i></button></span>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<span>&nbsp;부터&nbsp;~&nbsp;</span>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"input-group input-medium date date-picker\" data-date=\"");
      out.print(obox.get("inner_end_ymd",Box.DEF_DATE_FMT));
      out.write("\" data-date-format=\"yyyy-mm-dd\" data-date-viewmode=\"years\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"text\" name=\"end_ymd\" value=\"");
      out.print(obox.get("inner_end_ymd"));
      out.write("\" maxlength=\"8\" title=\"입원기간(까지)\" class=\"form-control tYMD\" onchange=\"calendarSettingPost('end_ymd')\">\r\n");
      out.write("\t\t\t\t\t\t\t<span class=\"input-group-btn\"><button class=\"btn dark\" type=\"button\"><i class=\"fa fa-calendar\"></i></button></span>\r\n");
      out.write("\t\t\t\t\t\t</div>&nbsp;까지&nbsp;\r\n");
      out.write("\t\t\t\t\t\t(총&nbsp;<input type=\"text\" name=\"inner_ilsu\" value=\"");
      out.print(obox.get("inner_ilsu"));
      out.write("\" maxlength=\"3\" title=\"입원일수\" class=\"form-control tMONEY\" style=\"width:25px\" readOnly>&nbsp;일)\r\n");
      out.write("\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      ...
      out.write("\" maxlength=\"10\" title=\"신청금액\" class=\"form-control required tMONEY\" style=\"width:70px\">&nbsp;원\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
...
if(!obox.get("slip_no").equals("")){
 ...
 if(uSesEnt.dbo.equals("SABOK26")) { 
      ...
      out.write("\t\t\t\t\t* 2차병원 이상에서 3일이상 입원 치료한 경우 본인 70%, 배우자 및 자녀 50%<br>\r\n");
      out.write("\t\t\t\t\t* 제증명 발급비용 제외 및 1원단위 절사<br>\r\n");
      out.write("\t\t\t\t\t* 첨부서류 : 진단서, 입퇴원확인서, 의료비 지출 영수증(계산서)\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t");
 } 
