 ...
 * Generated at: 2019-09-03 01:52:01 UTC
...
public final class s80000_005flist_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(!box.get("ajax_yn").equals("Y")) { 
      ...
      out.write("\t\tajaxReplaceForm(\"wel02001_list.do\", \"#main\", \"#divListData\", function() {\r\n");
      ...
      out.write("\t\tajaxReplaceForm(\"wel02003_edit.do\", \"#main\", \"#divFrame\");\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction goDetail(apply_no) {\r\n");
      out.write("\t\t$(\"tr[id^='tr_']\").removeClass(\"bg-yellow\");\r\n");
      out.write("\t\tif(apply_no != '') { $(\"tr[apply_no='\"+apply_no+\"']\").addClass(\"bg-yellow\"); }\r\n");
      out.write("\t\tvar pageUrl = 'wel02002_select.do?apply_no='+apply_no;\r\n");
 ...
 if(rsWp.get("apply_no",i).equals(box.get("apply_no"))) { 
      ...
      out.write("\r\n");
      out.write("\t<h1 class=\"page-title\">직원 복지연금 신청</h1>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t<span style=\"color:#01a1db;\">신청일자를 클릭</span>하면 해당 복지연금 신청 세부내역을 조회할 수 있습니다.\r\n");
      out.write("\t</div>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<th><a href=\"javascript:goSort('t1.support_item')\">지원항목</a></th>\r\n");
      out.write("\t\t\t\t\t\t\t<th><a href=\"javascript:goSort('t1.sign_status')\">상태</a></th>\r\n");
      out.write("\t\t          \t\t</tr>\r\n");
      out.write("\t\t\t\t\t</thead>\r\n");
      out.write("\t\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t");
 if(rsWp.getLength() == 0) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<t><td colspan=\"5\" class=\"t-center\">등록된 자료가 없습니다.</td></tr>\r\n");
      out.write("\t\t\t\t\t");
}else { 
						for(int i=0; i < rsWp.getLength(); i++) { 
      out.write("\r\n");
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"t-center\">");
      out.print(rsWp.get("support_item_nm",i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"t-center\">");
