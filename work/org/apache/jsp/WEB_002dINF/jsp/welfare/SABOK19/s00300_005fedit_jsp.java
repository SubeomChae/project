 ...
 * Generated at: 2019-09-26 04:19:04 UTC
...
return;
	...
	if(obox.get("sign_status").equals("") || obox.get("sign_status").equals("1") || obox.get("sign_status").equals("4")) { isEditable = true; }
      ...
      out.write("\r\n");
      out.write("<title>학자금 신청서 작성</title>\r\n");
 ...
 if(uSesEnt.dbo.equals("SABOK26")) { 
      ...
      out.write("\t\tremoveMask(\"#saveForm\");\r\n");
      out.write("\t\tdocument.saveForm.action = 'method=wel01002_select.do';\r\n");
      out.write("\t\tdocument.saveForm.target = '_self';\r\n");
      out.write("\t\tdocument.saveForm.submit();\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
...
for(int i=1;i<=15;i++){
 ...
 if(uSesEnt.dbo.equals("SABOK26")) { 
      ...
      out.write("\" size=\"20\" maxlength=\"20\" title=\"학과\" class=\"form-control\" style=\"width:100px\">\r\n");
      out.write("\t\t\t</td>\r\n");
 ...
 if(uSesEnt.dbo.equals("SABOK26")) { 
      out.write("\r\n");
      out.write("\t\t\t\t<select name=\"family_rel_cd\" title=\"가족관계\" class=\"bs-select form-control required\" style=\"width:70px;\">\r\n");
