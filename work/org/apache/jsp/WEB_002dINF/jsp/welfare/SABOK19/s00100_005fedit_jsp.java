 ...
 * Generated at: 2019-09-26 04:19:03 UTC
...
for(int i=1;i<=15;i++){
 ...
 if(uSesEnt.use_auth.startsWith("S")) { 
      ...
      out.write("\t\t\t<td width=\"35%\">\r\n");
      out.write("\t\t\t\t<select name=\"cong_class\" class=\"bs-select form-control required\" title=\"경조구분\" style=\"width:90px\" onChange=\"autoCongAmt()\">\r\n");
      ...
      out.write("\t\t\t<td width=\"35%\">\r\n");
      out.write("\t\t\t\t<select name=\"family_id\" title=\"대상자 선택\" class=\"bs-select form-control required\" style=\"width:115px\" onChange=\"changeFamilyId(this.value)\">\r\n");
      out.write("\t\t\t\t\t<option value=''>:: 선택 ::</option>\r\n");
      out.write("\t\t\t\t");
	RsWrapper familyWp = CodeUtil.getRsWrapper("PR_INSTB_EMPL12_LIST","LISTCODE", "", obox.get("empl_no"),"00","","","",uSesEnt.dbo);
      ...
      out.print(obox.get("cong_place"));
      out.write("\" size=\"50\" maxlength=\"50\" title=\"경조장소\" class=\"form-control required\" style=\"width:140px\">\r\n");
      out.write("\t\t\t</td>\r\n");
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
