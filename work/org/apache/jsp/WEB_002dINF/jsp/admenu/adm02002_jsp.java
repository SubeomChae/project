 ...
 * Generated at: 2019-09-03 04:16:15 UTC
...
public final class adm02002_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
 	...
 	if(uSesEnt.use_auth.equals("SA") && !obox.get("edit_flag").equals("N")) { isEditable = true; }
      ...
      out.write("\t\t\t\tajaxSubmitForm(\"adm02002_update.do\",\"#saveForm\", function(rtn) {\r\n");
      out.write("\t\t\t\t\tif(rtn.isOk == \"Y\") {\r\n");
      out.write("\t\t\t\t\t\talert('저장되었습니다.');\r\n");
      out.write("\t\t\t\t\t\tif(document.saveForm.action_type.value == 'INSERT') {\r\n");
      out.write("\t\t\t\t\t\t\tgoSearch(document.saveForm.code_group.value);\r\n");
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t}else {\r\n");
      ...
      out.write("\t\t\tajaxSubmitForm(\"adm02002_delete.do\",\"#saveForm\", function(rtn) {\r\n");
      out.write("\t\t\t\tif(rtn.isOk == \"Y\") {\r\n");
      ...
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction goDetail(code_group) {\r\n");
      out.write("\t\tremoveMask(\"#saveForm\");\r\n");
      ...
      out.print(box.get("code_group").equals("")?"INSERT":"UPDATE");
      out.write("\">\r\n");
      out.write("\r\n");
      out.write("\t<table class=\"table table-view table-bordered table-cover mar0\">\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th>코드그룹</th>\r\n");
      out.write("\t\t\t<td colspan=\"3\">\r\n");
      out.write("\t\t\t");
 if(box.get("code_group").equals("")) { 
      out.write("\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"code_group\" value=\"");
      out.print(obox.get("code_group"));
      out.write("\" title=\"코드그룹\" class=\"form-control required\" style=\"width:150px\">\r\n");
      out.write("\t\t\t");
 }else { 
      out.write("\r\n");
      out.write("\t\t\t\t<b>");
      ...
      out.write("\t\t</tr>\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th>코드명칭</th>\r\n");
      out.write("\t\t\t<td colspan=\"3\">\r\n");
      out.write("\t\t\t");
 if(isEditable) { 
      out.write("\r\n");
      out.write("\t\t\t\t<input type=\"text\" name=\"group_nm\" value=\"");
      out.print(obox.get("group_nm"));
      out.write("\" title=\"코드명칭\" class=\"form-control required\" style=\"width:300px\">\r\n");
      out.write("\t\t\t");
 }else { 
      out.write("\r\n");
      out.write("\t\t\t\t");
      out.print(obox.get("group_nm"));
      out.write("<input type=\"hidden\" name=\"group_nm\" value=\"");
      out.print(obox.get("group_nm"));
      out.write("\">\r\n");
      out.write("\t\t\t");
 } 
 ...
 if(isEditable) { 
      out.write("\r\n");
      out.write("\t\t\t\t<textarea name=\"code_desc\" class=\"form-control\" style=\"width:100%; height:70px;\">");
      out.print(obox.get("code_desc"));
      out.write("</textarea>\r\n");
      out.write("\t\t\t");
 }else { 
      out.write("\r\n");
      out.write("\t\t\t\t");
      out.print(obox.get("code_desc",Box.MULTILINE_TEXT));
      out.write("<input type=\"hidden\" name=\"code_desc\" value=\"");
      out.print(obox.get("code_desc"));
      out.write("\">\r\n");
      out.write("\t\t\t\t");
 } 
 ...
 if(!box.get("code_group").equals("")) { 
      ...
      out.write("\t\t\t<th>세부코드</th>\r\n");
      out.write("\t\t\t<td colspan=\"3\">");
      out.print(obox.get("dtl_cnt"));
      out.write(" 건&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t<button type=\"button\" class=\"btn btn-primary btn-table\" onClick=\"goDetail('");
      out.print(obox.get("code_group"));
      ...
      out.write("\r\n");
      out.write("\t\t<tr>\r\n");
      out.write("\t\t\t<th width=\"20%\">최초등록일시</th>\r\n");
      out.write("\t\t\t<td width=\"30%\">");
      out.print(obox.get("sys_reg_date",Box.DEF_DATETIME_FMT_APM));
      out.write("</td>\r\n");
      out.write("\t\t\t<th width=\"20%\">최종수정일시</th>\r\n");
      out.write("\t\t\t<td width=\"30%\">");
