 ...
 * Generated at: 2019-09-18 07:54:45 UTC
...
public final class adm21002_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\tajaxSubmitForm(\"adm21002_update.do\",\"#saveForm\", function(rtn) {\r\n");
      ...
      out.write("\t\t\t<h4 class=\"modal-title\">월간 주요일정 등록</h4>\r\n");
      out.write("\t\t</div>\r\n");
      ...
      out.print(box.get("sys_ymd"));
      out.write("\">\r\n");
      out.write("\t\t\t<table class=\"search-panel table table-bordered table-cover mar0\">\r\n");
      out.write("\t\t\t\t<tbody>\r\n");
      out.write("\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td class=\"td-head\">기준일자</td>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"3\" style=\"padding-left:5px\">");
      out.print(box.get("sys_ymd", Box.DEF_DATE_FMT));
      out.write("</td>\r\n");
      out.write("\t\t\t\t     </tr>\r\n");
      out.write("\t\t\t\t     <tr>\r\n");
      out.write("\t\t\t\t\t\t<td class=\"td-head\">선택</td>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"3\">\r\n");
      out.write("\t\t\t\t\t\t");
 if(box.get("day_of_week").equals("0")) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<font color=red>일요일</font>\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" name=\"holiday_yn\" value=\"Y\">\r\n");
      out.write("\t\t\t\t\t\t");
 }else { 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t<label class=\"mt-radio mt-radio-outline\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"radio\" name=\"holiday_yn\" value=\"N\" ");
      out.print(obox.get("holiday_yn").equals("Y")?"":"checked");
      out.write(" style=\"border:none;\"> 근무일&nbsp;&nbsp;<span/>\r\n");
      out.write("\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t<label class=\"mt-radio mt-radio-outline\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"radio\" name=\"holiday_yn\" value=\"Y\" ");
      out.print(obox.get("holiday_yn").equals("Y")?"checked":"");
      out.write(" style=\"border:none;\"> 공휴일<span/>\r\n");
      out.write("\t\t\t\t\t\t</label>\r\n");
      out.write("\t\t\t\t\t\t");
 } 
      out.write("\r\n");
      ...
      out.write("\t\t\t    \t</tr>\r\n");
      out.write("\t\t\t     \t<tr>\r\n");
      out.write("\t\t\t\t\t\t<td class=\"td-head\">일정</td>\r\n");
      out.write("\t\t\t\t\t\t<td colspan=\"3\"><input type=\"text\" name=\"etc_remark\" value=\"");
      out.print(obox.get("etc_remark"));
      out.write("\" maxlength=\"40\" title=\"일정\" class=\"form-control\" style=\"width:98%;ime-mode:active;\"></td>\r\n");
      out.write("\t\t\t     \t</tr>\r\n");
      out.write("\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t</table>\r\n");
      out.write("\t\t\t</form>\t\r\n");
      ...
      out.write("\t\t\t\t  \t\t<button type=\"button\" class=\"btn dark marR5\" onclick=\"$('button.close').trigger('click');\"><img src=\"/com/img/ico_btn_cancel.png\">취소</button>\r\n");
      out.write("\t\t\t\t  \t</span>\r\n");
      out.write("\t\t\t\t</span>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\t\t\t\t\r\n");
