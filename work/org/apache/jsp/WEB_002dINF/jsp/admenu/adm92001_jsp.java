 ...
 * Generated at: 2019-08-30 10:06:36 UTC
...
public final class adm92001_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(!box.get("ajax_yn").equals("Y")) { 
      ...
      out.write("\t\tajaxReplaceForm(\"adm92001_list.do\", \"#main\", \"#divListData\", function(){\r\n");
      ...
      out.write("\r\n");
      out.write("\t<h1 class=\"page-title\">시스템 접속로그</h1>\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t<tbody>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td class=\"td-head\">회사명</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t<select name=\"corp_cd\" class=\"bs-select form-control\" title=\"회사명\" style=\"width:99%\">\r\n");
      out.write("\t\t\t\t\t\t<option value=''>전체</option>\r\n");
      out.write("\t\t\t            ");
      out.print(CodeUtil.optList("PR_COMTB_CORP01_LIST","LISTCODE",box.get("corp_cd"),"","","","",""));
      out.write("\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td class=\"td-head\">접속일자</td>\t\r\n");
      out.write("\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<span class=\"input-group-btn\"><button type=\"button\" class=\"btn dark\"><i class=\"fa fa-calendar\"></i></button></span>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t<span> ~ </span>\r\n");
      out.write("\t\t\t\t\t\t<div class=\"input-group input-medium date date-picker\" data-date=\"");
      ...
      out.write(">client IP</option>\r\n");
      out.write("\t\t\t\t\t\t<option value='3' ");
      out.print(box.get("search_key").equals("3")?"selected":"");
      out.write(">action_type</option>\r\n");
      out.write("\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      ...
      out.write("\r\n");
      out.write("\t<div class=\"table-scrollable scrollOptionY\" style=\"width:100%; height:calc(100vh - 148px);\">\r\n");
      ...
      out.write("\t\t\t\t\t<th>connect date</th>\r\n");
      out.write("\t\t\t\t\t<th>Procedure Name</th>\r\n");
      out.write("\t\t\t\t\t<th>Action_type</th>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t</thead>\r\n");
      out.write("\t\t\t<tbody>\r\n");
      out.write("\t\t\t");
 for(int i=0; i < rsWp.getLength(); i++){ 
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("client_ip",i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("slog_date",i,Box.DEF_DATETIME_FMT_APM));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("proc_nm",i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t<td>");
      out.print(rsWp.get("action_type",i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t</tr>\r\n");
      out.write("\t\t\t");
 } 
