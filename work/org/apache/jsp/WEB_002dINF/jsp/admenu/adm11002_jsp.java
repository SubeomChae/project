 ...
 * Generated at: 2019-09-03 04:21:54 UTC
...
public final class adm11002_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\tif(formValidate(\"#upload\")) { \r\n");
      out.write("\t\t\tif(confirm('저장하시겠습니까?')) {\r\n");
      out.write("\t\t\t\tajaxSubmitForm(\"adm11002_update.do\", '#upload', function(rtn) {\r\n");
      ...
      out.write("\t\r\n");
      out.write("\t$(function() {\r\n");
      out.write("\t\t$(\".page-logo-text\").html(\"도움말\");\t\r\n");
      out.write("\t});\r\n");
      out.write("</script>\r\n");
      out.write("<form id=\"upload\" name=\"upload\" method=\"post\" action=\"\" class=\"fType\" enctype=\"multipart/form-data\" style=\"margin:0px\">\r\n");
      out.write("<input type=\"hidden\" name=\"menu_id\"\t\t    value=\"");
      out.print(box.get("menu_id"));
      out.write("\">\r\n");
      out.write("<input type=\"hidden\" name=\"pathKey\"\t\t    value=\"userfile\">\r\n");
      ...
      out.write("\t\t</colgroup>\t\t\t\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>도움말개요</th>\r\n");
      out.write("\t\t\t\t<td class=\"t_left\"><textarea name=\"intro_msg\" title=\"도움말개요\" class=\"required\" style=\"width:100%;height:80px;;ime-mode:active;\">");
      out.print(obox.get("intro_msg"));
      out.write("</textarea></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>이미지파일</th>\r\n");
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t");
 if(!obox.get("file_nm").equals("")) { 
      ...
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"file\" id=\"upload_file\" name=\"upload_file\" onChange=\"checkUploadFile(this.value, 'img')\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t</span>\t\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t<td class=\"t_left\"><textarea name=\"help_content\" title=\"세부내용\" class=\"form-control required\" style=\"width:100%;height:470px;\">");
      out.print(obox.get("help_content"));
      out.write("</textarea></td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th>그 밖의 참고사항</th>\r\n");
      out.write("\t\t\t\t<td class=\"t_left\"><textarea name=\"etc_remark\" title=\"그 밖의 참고사항\" class=\"form-control\" style=\"width:100%;height:50;\">");
      ...
      out.write("\t\t\t<button type=\"button\" class=\"btn dark\" onclick=\"self.close();\"><img src=\"/com/img/ico_btn_cancel.png\">취소</button>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</form>\r\n");
