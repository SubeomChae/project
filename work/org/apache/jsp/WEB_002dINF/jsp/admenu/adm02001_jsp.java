...
public final class adm02001_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
 ...
 if(!box.get("ajax_yn").equals("Y")) { 
      ...
      out.write("\t\tajaxReplaceForm(\"adm02001_list.do\", \"#main\", \"#divListData\", function() {\r\n");
      out.write("\t\t\tvar code_group = $(\"tr[id='tr_0']\").attr(\"code_group\");\r\n");
      out.write("\t\t\tif(code_group != undefined) { goEdit(code_group); }\r\n");
      out.write("\t\t\tfixTableHeader(\"MyTable\");\r\n");
      out.write("\t\t});\r\n");
      out.write("\t}\r\n");
      out.write("\r\n");
      out.write("\tfunction goEdit(code_group) {\r\n");
      out.write("\t\t$(\"tr[id^='tr_']\").removeClass(\"bg-yellow\");\r\n");
      out.write("\t\tif(code_group != '') { $(\"tr[code_group='\"+code_group+\"']\").addClass(\"bg-yellow\"); }\r\n");
      out.write("\t\tvar pageUrl = 'adm02002_edit.do?code_group='+code_group;\r\n");
 ...
 if(rsWp.get("code_group",i).equals(box.get("code_group"))) { 
      out.write("\r\n");
      out.write("\t\t\t\t$(\"tr[code_group='\"+code_group+\"']\").addClass(\"bg-yellow\");\r\n");
      out.write("\t\t\t\tgoEdit('");
 ...
 if(uSesEnt.use_auth.equals("SA")) { 
      out.write("\r\n");
      out.write("\t\t\t\t\t<button type=\"button\" class=\"btn dark f-right marR60\" onClick=\"goEdit('');\"><img src=\"/com/img/ico_btn_refresh_edit.png\">새로작성</button>\r\n");
      out.write("\t\t\t\t");
 } 
      out.write("\r\n");
      out.write("\t \t\t\t</td>\r\n");
      ...
      out.write("\t\t\t<div class=\"table-scrollable scrollOptionY\" style=\"width:100%; height:calc(100vh - 121px);\">\r\n");
 ...
 for(int i=0; i < rsWp.getLength(); i++) { 
      ...
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td class=\"t-left\">");
if(rsWp.get("edit_flag",i).equals("X")){
      out.write("<font color=red>(회사별)</font> ");
}
      out.print(rsWp.get("group_nm",i));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t</tr>\t\r\n");
      out.write("\t\t\t\t\t");
 } 
