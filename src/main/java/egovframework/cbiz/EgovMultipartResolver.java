...
public class EgovMultipartResolver extends CommonsMultipartResolver {
	...
	/**
	 * Extends ServletFileUpload.isMultipartContent() behavior to allow PUT
	 * requests as multipart.
	 * 
	 * @param request
	...
	protected MultipartParsingResult parseFileItems(List fileItems, String encoding) {
		...
		Map<String, String> multipartContType = new HashMap<String, String>();
		...
		for (Iterator it = fileItems.iterator(); it.hasNext();) {
			...
			if (fileItem.isFormField()) {
				...
				multipartContType.put(fileItem.getFieldName(), fileItem.getContentType());
			} else {
		...
		return new MultipartParsingResult(multipartFiles, multipartParameters, multipartContType);
	}
}