...
public class SeedCipher {
	...
	// 암호화 모듈
	public static String encode(String decryptText) throws Exception {
		if(decryptText.equals("")) { return ""; }
		String key = "sinjin-it-consulting";
		SeedCipher seed = new SeedCipher();
		String encryptText = Base64.encode(seed.encrypt(decryptText, key.getBytes(), "UTF-8"));
		return encryptText;
	}

	// 복호화 모듈
	public static String decode(String encryptText) throws Exception {
		if(encryptText.equals("")) { return ""; }
		String key = "sinjin-it-consulting";
		SeedCipher seed = new SeedCipher();
	...
	// 암호화 키
	public static String encodeKey(String decryptText) throws Exception {
		String encKey = encode(decryptText);
		encKey = StringUtil.replace(encKey,"/","_");
		encKey = StringUtil.replace(encKey,":","_");
		encKey = StringUtil.replace(encKey,"*","_");
		encKey = StringUtil.replace(encKey,"?","_");
		encKey = StringUtil.replace(encKey,"<","_");
