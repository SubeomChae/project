...
<%	String apply_no = box.get("params");
	...
	table.addCell(PdfUtil.cellFormat(obox.get("family_rel_nm").equals("")?obox.get("family_nm"):"["+obox.get("family_rel_nm")+"] "+obox.get("family_nm"), font_data, "LEFT", "", "", "m25", "0,5,0,5"));
	table.addCell(PdfUtil.cellFormat("경조일자", font_head, "", "", "LIGHT_GRAY", "m25", ""));
	table.addCell(PdfUtil.cellFormat(obox.get("start_ymd",Box.DEF_DATE_FMT), font_data, "LEFT", "", "", "m25", "0,5,0,5"));
