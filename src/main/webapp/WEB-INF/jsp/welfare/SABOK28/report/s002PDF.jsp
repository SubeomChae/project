...
<%	String apply_no = box.get("params");
	...
	table.addCell(PdfUtil.cellFormat("진료기간", font_head, "", "", "LIGHT_GRAY", "m25", ""));
	table.addCell(PdfUtil.cellFormat(obox.get("inner_start_ymd",Box.DEF_DATE_FMT)+" ~ "+obox.get("inner_end_ymd",Box.DEF_DATE_FMT)+" (진료일수 :"+obox.get("inner_ilsu")+"일)", font_data, "LEFT", "", "", "m25", "0,5,0,5", "col3"));
