...
<title>주택임차 및 구입비용지원 신청서</title>
</head>
<body>
<%	String apply_no = box.get("params");
	Box obox = CodeHelper.getRsBox("PR_REPORT_SQL", "WEL01001", apply_no, "S024","","","",request);
	...
	Paragraph title = new Paragraph("주택임차 및 구입비용지원 신청서", font_title);
	...
	if(obox.get("sign_status").equals("3")) {
		...
		table2.addCell(PdfUtil.cellFormat("분기 "+obox.get("apply_amt",Box.THOUSAND_COMMA)+" 원", font_data, "LEFT", "", "", "m25", "0,5,0,5"));
