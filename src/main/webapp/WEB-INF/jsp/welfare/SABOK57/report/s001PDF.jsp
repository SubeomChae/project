...
<%	String apply_no = box.get("params");
	Box obox = CodeHelper.getRsBox("PR_REPORT_SQL", "WEL01001", apply_no, "S001","","","",request);
	...
	Paragraph title = new Paragraph("경조금신청서", font_title);
	...
	table.addCell(PdfUtil.cellFormat("경조구분", font_head, "", "", "LIGHT_GRAY", "m25", ""));
	table.addCell(PdfUtil.cellFormat(obox.get("cong_class_nm"), font_data, "LEFT", "", "", "m25", "0,5,0,5"));
	...
	table.addCell(PdfUtil.cellFormat("경조일자", font_head, "", "", "LIGHT_GRAY", "m25", ""));
	table.addCell(PdfUtil.cellFormat(obox.get("start_ymd",Box.DEF_DATE_FMT), font_data, "LEFT", "", "", "m25", "0,5,0,5", "col3"));
	table.addCell(PdfUtil.cellFormat("경조장소", font_head, "", "", "LIGHT_GRAY", "m25", ""));
	table.addCell(PdfUtil.cellFormat(obox.get("cong_place"), font_data, "LEFT", "", "", "m18", "0,5,0,5", "col3"));
