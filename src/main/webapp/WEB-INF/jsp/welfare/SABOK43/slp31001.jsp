		...
		<td align="center">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
		  		<tr height="28">
					...
					<td width="*" style="padding-left:5px"><input type="text" name="search_val" value="<%=box.get("search_val")%>" style="width:120px; border:1 solid gray;ime-mode:active;" onkeydown="if(event.keyCode == 13) goSearch('N')"></td>
		  		</tr>
		  		<tr height="28">
