	...
	<div class="table-scrollable">
		<table class="table table-view table-bordered">
			...
			<tr>
				<th>총영수금액</th>
				<td>
					<input type="text" name="use_amt" value="<%=obox.get("use_amt")%>" maxlength="10" title="총영수금액" class="form-control tMONEY" style="width:70px">&nbsp;원
				</td>
				<th>임플란트 여부</th>
				<td>
					<select name="implant_yn" title="임플란트여부" class="bs-select form-control" style="width:117px">
						<option value='N' <%=!obox.get("implant_yn").equals("Y")?"selected":""%>>아니오</option>
						<option value='Y' <%=obox.get("implant_yn").equals("Y")?"selected":""%>>예</option>
			        </select>
				</td>
			</tr>
			<tr>
