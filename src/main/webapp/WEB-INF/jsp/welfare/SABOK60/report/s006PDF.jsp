...
<title>사내동호인회신청서</title>
</head>
<body>
<%	String apply_no = box.get("params");
	Box obox = CodeHelper.getRsBox("PR_REPORT_SQL", "WEL01001", apply_no, "S006","","","",request);
	...
	Paragraph title = new Paragraph("사내동호인회신청서", font_title);
	...
	table.addCell(PdfUtil.cellFormat("동호인회", font_head, "", "", "LIGHT_GRAY", "m25", ""));
	table.addCell(PdfUtil.cellFormat(obox.get("sub_nm"), font_data, "LEFT", "", "", "m25", "0,5,0,5", "col3"));
	table.addCell(PdfUtil.cellFormat("행사일자", font_head, "", "", "LIGHT_GRAY", "m25", ""));
	table.addCell(PdfUtil.cellFormat(obox.get("start_ymd",Box.DEF_DATETIME_FMT)+" ~ "+obox.get("end_ymd",Box.DEF_DATETIME_FMT), font_data, "LEFT", "", "", "m25", "0,5,0,5", "col3"));
	table.addCell(PdfUtil.cellFormat("장소", font_head, "", "", "LIGHT_GRAY", "m25", ""));
	table.addCell(PdfUtil.cellFormat(obox.get("event_place"), font_data, "LEFT", "", "", "m25", "0,5,0,5", "col3"));
	table.addCell(PdfUtil.cellFormat("행사내용", font_head, "", "", "LIGHT_GRAY", "m25", ""));
	table.addCell(PdfUtil.cellFormat(obox.get("event_content"), font_data, "LEFT", "", "", "m25", "0,5,0,5", "col3"));
