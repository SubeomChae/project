	...
	<div class="table-scrollable">
		<table class="table table-view table-bordered">
			<tr>
				...
				<td width="35%">
					<input type="text" name="self_pay_amt" value="<%=obox.get("self_pay_amt")%>" maxlength="10" title="본인부담금" class="form-control tMONEY" style="width:90%">&nbsp;원
				</td>
			</tr>
			<tr>
				<th>신청일자</th>
				...
				<th>신청금액</th>
				<td>
					<input type="text" name="support_amt" value="<%=obox.get("support_amt")%>" maxlength="10" class="form-control required tMONEY" class="required" title="신청금액" style="width:90%">&nbsp;원
