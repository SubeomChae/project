...
<script language="javascript">
	...
	function goWrite() {
		...
		document.main.action = 'wel01003_edit';
	...
	<tr>
		<td valign="top" style="padding:10px 10px 0 10px;">
	      <table width="100%" height="" cellpadding="0" cellspacing="0" border="0">
	        <tr>
	          <td height="35" class="cont_title">건강검진지원 신청</td>
	        </tr>
		  </table>
		</td>
			...
			<table width="100%" border="0" cellspacing="0" bgcolor="#ffffff">
				<tr>
				  	<td colspan="2" class="table_description">
				  		<span style="font-weight:bold; color:#01a1db;">신청일자를 클릭</span>하면 해당 건강검진지원 신청 세부내역을 조회할 수 있습니다.
				  	</td>
				</tr>
          		<tr>
					<td width="40%" valign="top">
						...
						<table width="100%" border="1" cellpadding="0" cellspacing="0" class="table01">
							<tr height="28" align="center" class="table01_title">
								<td width="20%"><a href="javascript:goSort('t1.apply_ymd')">신청일자</a></td>
								<td width="*"><a href="javascript:goSort('t3.dept_nm')">부서명</a></td>
								<td width="20%"><a href="javascript:goSort('t2.empl_nm')">성명</a></td>
								<td width="15%"><a href="javascript:goSort('t4.sign_status')">상태</a></td>
			          		</tr>
						<% if(rsWp.getLength() == 0) { %>
