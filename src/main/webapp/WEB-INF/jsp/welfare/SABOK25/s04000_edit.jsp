		...
		<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
				<tr height="28">
					...
					<td width="35%" style="padding-left:5px"><input type="text" name="apply_amt" value="<%=obox.get("apply_amt")%>" size="13" maxlength="10" class="required tMONEY" class="required" title="신청금액" style="width:90px;border:1 solid gray" > 원</td>
				</tr>
				<tr height="28">
