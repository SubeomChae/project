...
<%	String bank_cd;
	...
	RsWrapper codeWp = CodeUtil.getRsWrapper("PR_COMTB_CODE02_LIST","MULTCODE", "", "cong_class@"+uSesEnt.dbo+bank_cd,"","","","",uSesEnt.dbo);
...
<%	RsWrapper congWp = CodeUtil.getRsWrapper("PR_COMTB_CODE02_LIST","LIST001", "", "cong_class@"+uSesEnt.dbo,"","","","",uSesEnt.dbo);
...
<%@ include file="/WEB-INF/jsp/welfare/payGuide.jsp" %>
	...
	<table class="table table-view table-bordered table-cover marB5">
		...
		<tr> 
			<th>경조장소</th>
			<td colspan="3">
				<input type="text" name="cong_place" value="<%=obox.get("cong_place",Box.SPECIAL_CHAR)%>" title="경조장소" class="form-control required" style="width:140px">
			</td>
		</tr>
		<tr>
			<th>신청일자</th>
