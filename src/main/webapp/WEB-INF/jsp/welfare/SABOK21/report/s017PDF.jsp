...
<%	String apply_no = box.get("params");
	Box obox = CodeHelper.getRsBox("PR_REPORT_SQL", "WEL01001", apply_no, "S017","","","",request);
	...
	Paragraph title = new Paragraph("상해보험지원", font_title);
	...
	table.addCell(PdfUtil.cellFormat("보험구분", font_head, "", "", "LIGHT_GRAY", "m25", ""));
	table.addCell(PdfUtil.cellFormat(obox.get("sub_nm"), font_data, "LEFT", "", "", "m25", "0,5,0,5"));
	table.addCell(PdfUtil.cellFormat("보험기간", font_head, "", "", "LIGHT_GRAY", "m25", ""));
	table.addCell(PdfUtil.cellFormat(obox.get("data02",Box.DEF_DATE_FMT) + " ~ " + obox.get("data03",Box.DEF_DATE_FMT), font_data, "LEFT", "", "", "m25", "0,5,0,5"));

	table.addCell(PdfUtil.cellFormat("보험료", font_head, "", "", "LIGHT_GRAY", "m25", ""));
	table.addCell(PdfUtil.cellFormat(obox.get("data01",Box.THOUSAND_COMMA), font_data, "LEFT", "", "", "m25", "0,5,0,5"));
	table.addCell(PdfUtil.cellFormat("보험수익자", font_head, "", "", "LIGHT_GRAY", "m25", ""));
	table.addCell(PdfUtil.cellFormat(obox.get("data04",Box.MULTILINE_TEXT), font_data, "LEFT", "", "", "m25", "0,5,0,5"));
