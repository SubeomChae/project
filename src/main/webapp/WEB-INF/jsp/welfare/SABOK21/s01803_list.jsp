...
<input type="hidden" name="selectedRow" value="">
	...
	<h1 class="page-title">문화활동비지원</h1>
...
<% } %>
	<div class="table-top-guide">
		<span style="color:#01a1db;">신청일자를 클릭</span>하면 해당 문화활동비 지원비 신청 세부내역을 조회할 수 있습니다.
	</div>
				...
				<table id="MyTable" class="table table-striped table-bordered table-hover order-column">
					...
					<thead>
						<tr>
							...
							<th><a href="javascript:goSort('t1.bugt_cd')">문화활동</a></th>
