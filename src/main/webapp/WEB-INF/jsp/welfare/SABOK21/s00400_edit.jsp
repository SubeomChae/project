	...
	<div class="table-scrollable">
		<table class="table table-view table-bordered">
			<tr>
				<th>교육명</th>
				<td>
					<input type="text" name="course_nm" value="<%=obox.get("course_nm")%>" size="30" title="교육명" class="form-control required" style="width:240px">	
				</td>
				<th>교육비</th>
				<td>
					<input type="text" name="use_amt" value="<%=obox.get("use_amt")%>" size="13" title="교육비" class="form-control required tMONEY" style="width:90px" > 원
				</td>
			</tr>
			<tr>
				<th>교육일자</th>
				<td colspan="3">
					<div class="form-inline">
						...
						(교육일수 : <input type="text" name="edu_ilsu" value="<%=obox.get("edu_ilsu")%>" maxlength="3" title="교육일수" class="form-control tMONEY" style="width:35px" readonly>&nbsp;일)
					</div>	
				</td>
			</tr>
			<tr>
				<th width="15%">교육기관</th>
				<td width="35%">
					<input type="text" name="edu_org_nm" value="<%=obox.get("edu_org_nm")%>" maxlength="50" title="교육기관" class="form-control required" style="width:240px">
				</td>
				<th width="15%">기관연락처</th>
				<td width="35%">
					<select name="edu_org_tel1" title="전화번호" class="bs-select form-control" style="width:65px">
						<option value=''>선택</option>
						<%=CodeUtil.optList(codeWp, "tel_no", StringUtil.arrayCol(obox.get("edu_org_tel"),1,"-"))%>
					</select> - 
					<input type="text" name="edu_org_tel2" value="<%=StringUtil.arrayCol(obox.get("edu_org_tel"),2,"-")%>" maxlength="4" title="전화번호" class="form-control autoTab" style="width:65px"> - 
					<input type="text" name="edu_org_tel3" value="<%=StringUtil.arrayCol(obox.get("edu_org_tel"),3,"-")%>" maxlength="4" title="전화번호" class="form-control autoTab" style="width:65px">
				</td>
			</tr>
			<tr> 
				<th>기관주소</th>
				<td colspan="3">
					<input type="text" name="edu_org_addr" value="<%=obox.get("edu_org_addr")%>" maxlength="50" title="기관주소" class="form-control required" style="width:400px">
				</td>
			</tr>
			<tr>
				<th>신청일자</th>
				...
				<th>신청금액</th>
				<td>
					<input type="text" name="apply_amt" value="<%=obox.get("apply_amt")%>" maxlength="10" title="신청금액" class="form-control required tMONEY" style="width:90px" > 원
				</td>
			</tr>
			<tr>
				<th>계좌번호</th>
			...
			<tr>
				<th>비고</th>
				<td colspan="3">
					<input type="text" name="etc_remark" value="<%=obox.get("etc_remark")%>" maxlength="120" class="form-control" title="비고" style="width:90%">
				</td>
			</tr>
