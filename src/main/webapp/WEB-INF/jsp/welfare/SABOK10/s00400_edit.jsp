...
<%@ include file="/WEB-INF/jsp/welfare/payGuide.jsp" %>
	...
	<table class="table table-view table-bordered table-cover marB5">
		...
		<tr>
			...
			<td width="35%">
				<select name="edu_org_tel1" title="전화번호" class="bs-select form-control style="width:70px">
		...
		<tr> 
			<th>기관주소</th>
			<td colspan="3">
				<input type="text" name="edu_org_addr" value="<%=obox.get("edu_org_addr")%>" size="50" maxlength="50" title="기관주소" class="form-control required" style="width:400px">
			</td>
		</tr>
		<tr>
			<th>신청일자</th>
