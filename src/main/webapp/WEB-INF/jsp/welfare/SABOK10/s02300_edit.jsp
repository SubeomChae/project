...
<%	String bank_cd;
	...
	RsWrapper codeWp = CodeUtil.getRsWrapper("PR_COMTB_CODE02_LIST","MULTCODE", "", bank_cd,"","","","","");
...
<%@ include file="/WEB-INF/jsp/welfare/payGuide.jsp" %>
	...
	<table class="table table-view table-bordered table-cover marB5">
		<tr>
			...
			<td colspan="3">
				<div class="input-group input-medium date date-picker" data-date="" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
					<input type="text" name="start_ymd" value="<%=box.get("start_ymd")%>" maxlength="8" title="구입일자" class="form-control required tYMD">
		...
		<tr>
			...
			<th width="15%">신청금액</th>
			<td width="35%"><input type="text" name="apply_amt" value="<%=box.get("apply_amt").equals("") ? "70000" : obox.get("apply_amt")%>" size="13" maxlength="10" title="신청금액" class="form-control required tMONEY" style="width:90px;" > 원</td>
		</tr>
		<tr>
			<th>계좌번호</th>
			<td colspan="3">
