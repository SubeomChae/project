...
<title>꽃바구니지원신청서</title>
</head>
<body>
<%	String apply_no = box.get("params");
	Box obox = CodeHelper.getRsBox("PR_REPORT_SQL", "WEL01001", apply_no, "S023","","","",request);
	...
	Paragraph title = new Paragraph("꽃바구니지원신청서", font_title);
	...
	table.addCell(PdfUtil.cellFormat("구입일자", font_head, "", "", "LIGHT_GRAY", "m25", ""));
