...
<%	String apply_no = box.get("params");
	...
	Paragraph title = new Paragraph("유아자녀교육비신청서", font_title);
	...
	table.addCell(PdfUtil.cellFormat("["+obox.get("family_rel_nm")+"] "+obox.get("family_nm"), font_data, "LEFT", "", "", "m25", "0,5,0,5", "col3"));
