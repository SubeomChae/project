...
<% } %>
	<div class="table-top-guide">
		<span style="color:#01a1db;">신청일자를 클릭</span>하면 해당 휴양시설이용 신청 세부내역을 조회할 수 있습니다.
	</div>
				...
				<table id="MyTable" class="table table-striped table-bordered table-hover order-column">
					...
					<thead>
						<tr>
							...
							<th><a href="javascript:goSort('t1.data01, t1.data02')">휴양지</a></th>
