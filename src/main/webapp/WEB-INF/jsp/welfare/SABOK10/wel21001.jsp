...
<script language='javascript'>
	...
	function changeBugtCd(bugt_cd) {
		...
		if(bugt_cd == 'S001') {
			...
			cHtml = "";
			document.main.excel_file_nm.value = '유아자녀교육비 지원현황';
		}else if(bugt_cd == '') {
			cHtml = "";
	...
	<table class="search-panel table table-bordered">
		...
		<tbody>
	  		<tr>
				...
				<td class="td-head">
					<select name="search_key" class="form-control" style="width:90px">
				...
				<td>
					<select name="sign_status" title="결재상태" class="form-control" style="width:100px">
						<option value=''>전체</option>
