...
<%	String bank_cd;
	...
	RsWrapper codeWp = CodeHelper.getRsWrapper("PR_COMTB_CODE02_LIST","MULTCODE", "", bank_cd,"","","","","",request);
	boolean isEditable = false;
	if(obox.get("sign_status").equals("") || obox.get("sign_status").equals("1") || obox.get("sign_status").equals("4")) { isEditable = true; }
%>

<title><%if(uSesEnt.dbo.equals("SABOK19")){%>자녀양육비<%}else{%>유아자녀교육비<%}%> 신청서 작성</title>
		...
		<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">	
				<tr height="28">
					...
					<td colspan="4" width="35%" style="padding-left:5px">
