...
<title><%if(uSesEnt.dbo.equals("SABOK19")){%>자녀양육비<%}else{%>유아자녀교육비<%}%></title>
	...
	<tr>
		<td valign="top" style="padding:10px 10px 0 10px;">
	      <table width="100%" height="" cellpadding="0" cellspacing="0" border="0">
	        <tr>
	          <td height="35" class="cont_title"><%if(uSesEnt.dbo.equals("SABOK19")){%>자녀양육비<%}else{%>유아자녀교육비<%}%> 신청</td>
	        </tr>
		  </table>
		</td>
			...
			<table width="100%" border="0" cellspacing="0" bgcolor="#ffffff">
				<tr>
				  	<td colspan="2" class="table_description">
				  		<span style="font-weight:bold; color:#01a1db;">신청일자를 클릭</span>하면 해당 <%if(uSesEnt.dbo.equals("SABOK19")){%>자녀양육비<%}else{%>유아자녀교육비<%}%> 신청 세부내역을 조회할 수 있습니다.
				  	</td>
				</tr>
          		<tr>
