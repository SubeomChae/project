		...
		<tr>
			...
			<td width="35%">
				<select name="data12" class="bs-select form-control required" style="width:40%">
					...
					<option value='첫째' <%=box.get("data12").equals("첫째")?"selected":""%>>첫째</option>
					<option value='둘째' <%=box.get("data12").equals("둘째")?"selected":""%>>둘째</option>
					<option value='셋째' <%=box.get("data12").equals("셋째")?"selected":""%>>셋째</option>
				</select>
			</td>
			<th width="15%">자녀나이</th>
			<td width="35%">
				<input type="text" name="data13" value="<%=obox.get("data13")%>" size="10" maxlength="15" title="자녀나이"  class="form-control required" style="width:45px">
			</td>
		</tr>
		<tr>
			<th width="15%">신청일자</th>
