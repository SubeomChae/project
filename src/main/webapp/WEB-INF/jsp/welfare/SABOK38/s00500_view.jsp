...
<input type="hidden" name="apply_no" 	value="<%=box.get("apply_no")%>">
	...
	<div class="table-bottom-control">
		...
		<% } %>
			<button type="button" class="btn dark" onClick="goRptViewer('WEB-INF/jsp/welfare/<%=uSesEnt.dbo%>/report/s005PDF', '<%=box.get("apply_no")%>');"><img src="/com/img/ico_btn_print.png">인쇄</button>
		</span>
	</div>
</form>
