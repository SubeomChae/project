...
<table width="100%" border="0" cellspacing="0" bgcolor="#ffffff">
		...
		<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
				...
				<% if(uSesEnt.corp_cd.equals("SABOK10")) { %>
					<td align="center" class="table01_title">진료기간</td>
				<% }else  {%>
	...
	<tr>
		...
		<% } %>
			<a href="javascript:go_rpt_viewer('welfare/<%=box.get("dbo")%>/report/s002PDF', '<%=box.get("apply_no")%>');"><img src="/com/img/bn_print.gif" border="0" align="absmiddle" alt="인쇄">
		</td>
	</tr>
</table>
</form>
