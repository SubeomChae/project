...
<table width="100%" border="0" cellspacing="0" bgcolor="#ffffff">
		...
		<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
				<tr height="28">
					...
					<td colspan="3" style="padding-left:5px"><%=obox.get("sub_nm")%></td>
				</tr>
				<tr height="28">
				...
				<tr height="28">
					...
					<td colspan="3" style="padding-left:5px"><%=obox.get("event_place")%></td>
				</tr>
				<tr height="50">
	...
	<tr>
		...
		<% } %>
			<a href="javascript:go_rpt_viewer('welfare/<%=box.get("dbo")%>/report/s006PDF', '<%=box.get("apply_no")%>');"><img src="/com/img/bn_print.gif" border="0" align="absmiddle" alt="인쇄">
		</td>
	</tr>
</table>
</form>
