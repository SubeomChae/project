...
<script language="javascript">
	...
	function sign_request_post() {
		document.main.action = 'wel01002_select';
		document.main.target = '_self';
		document.main.submit();
	}
</script>
...
<table width="100%" border="0" cellspacing="0" bgcolor="#ffffff">
	...
	<tr>
		...
		<% } %>
			<a href="javascript:go_rpt_viewer('welfare/<%=box.get("dbo")%>/report/s001PDF', '<%=box.get("apply_no")%>');"><img src="/com/img/bn_print.gif" border="0" align="absmiddle" alt="인쇄">
		</td>
	</tr>
</table>
</form>
