	...
	<table class="search-panel table table-bordered">
		...
		<tbody>
			<tr>
				...
				<td>
					<select name="sign_status" title="결재상태" class="bs-select form-control" style="width:80px">
						<option value=''>전체</option>
	...
	<div id="divArea" class="table-scrollable scrollOptionY" style="height:calc(100vh - 200px)">
		...
		<% }else {
				...
				<% if(bugt_cd.equals("")) { %>
					...
					<td width="10%" class="t-center"><a href="javascript:goSlipViewer('&slip_no=<%=rsWp.get("slip_no",i)%>');"'<%=rsWp.get("slip_no",i)%>');"><%=rsWp.get("slip_no",i,Box.SLIP_NO)%></a></td>
				<% } %>
