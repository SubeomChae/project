	...
	<tr>
		<td valign="top" style="padding:10px 10px 0 10px;">
	      <table width="100%" height="" cellpadding="0" cellspacing="0" border="0">
	        <tr>
	          <td height="35" class="cont_title">의료비 신청</td>
	        </tr>
		  </table>
		</td>
			...
			<table width="100%" border="0" cellspacing="0" bgcolor="#ffffff">
				<tr>
				  	<td colspan="2" class="table_description">
				  		<span style="font-weight:bold; color:#01a1db;">대상자를 클릭</span>하면 해당 의료비 상세내역을 조회할 수 있습니다.
				  	</td>
				</tr>
          		<tr>
					<td width="40%" valign="top">
						...
						<table width="100%" border="1" cellpadding="0" cellspacing="0" class="table01">
							<tr height="28" align="center" class="table01_title">
								<td width="18%"><a href="javascript:goSort('t1.apply_ymd')" title="신청일순 정렬">신청일자</a></td>
								<td width="30%"><a href="javascript:goSort('t3.dept_nm')" title="부서명순 정렬">부서명</a></td>
								<td width="15%"><a href="javascript:goSort('t2.empl_nm')" title="성명순 정렬">성명</a></td>
...
<script language="javascript">
	document.getElementById("divArea").style.height = document.body.clientHeight - 150;
	document.getElementById("frmArea").style.height = document.body.clientHeight - 150;
</script>
