...
<table width="100%" border="0" cellspacing="0" bgcolor="#ffffff">
	...
	<tr>
		...
		<% } %>
			<a href="javascript:goUbiViewer('welfare/<%=box.get("dbo")%>/report/s001.jrf', 'P_PARAM01!SLP002,<%=box.get("apply_no")%>!P_PARAM02!ACCTB_SLIP01|<%=obox.get("slip_no")%>|<%=obox.get("apply_no")%>|<%=obox.get("bugt_cd")%>,<%=obox.get("bugt_cd")%>!');"><img src="/com/img/bn_print.gif" border="0" align="absmiddle" alt="인쇄"></a>
		</td>
	</tr>
</table>
</form>
