...
<table width="100%" border="0" cellspacing="0" bgcolor="#ffffff">
		...
		<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
				<tr height="28">
					...
					<td width="35%" style="padding-left:5px"><%=obox.get("disease_nm")%></td>
				</tr>
				<tr height="28">
					<td align="center" class="table01_title">의료기관</td>
					<td style="padding-left:5px"><%=obox.get("medi_org_nm")%></td>
					<td align="center" class="table01_title">소재지</td>
					<td  style="padding-left:5px"><%=obox.get("medi_org_addr")%></td>
				</tr>
				<tr height="28">
					<td align="center" class="table01_title">진료일자</td>
					<td style="padding-left:5px"><%=obox.get("medi_ymd",Box.DEF_DATE_FMT)%></td>
					<td align="center" class="table01_title">사용금액</td>
					<td style="padding-left:5px"><%=obox.get("use_amt",Box.THOUSAND_COMMA)%><%if(!obox.get("use_amt").equals("")){%> 원 <%}%></td>
				</tr>
				<tr height="28">
					<td align="center" class="table01_title">입원기간</td>
					<td colspan="3" style="padding-left:5px"><%=obox.get("inner_start_ymd",Box.DEF_DATE_FMT)%> ~ <%=obox.get("inner_end_ymd",Box.DEF_DATE_FMT)%>
				...
				<tr height="28">
					...
					<td style="padding-left:5px"><%=obox.get("apply_amt",Box.THOUSAND_COMMA)%> 원 
				</tr>
				<tr height="28">
	...
	<tr>
		...
		<% } %>
			<a href="javascript:goUbiViewer('welfare/<%=box.get("dbo")%>/report/s002.jrf', 'P_PARAM01!SLP002,<%=box.get("apply_no")%>!P_PARAM02!ACCTB_SLIP01|<%=obox.get("slip_no")%>|<%=obox.get("apply_no")%>|<%=obox.get("bugt_cd")%>,<%=obox.get("bugt_cd")%>!');"><img src="/com/img/bn_print.gif" border="0" align="absmiddle" alt="인쇄"></a>
		</td>
	</tr>
</table>
</form>
