...
<table width="100%" border="0" cellspacing="0" bgcolor="#ffffff">
		...
		<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
				<tr height="28">
					...
					<td width="35%" style="padding-left:5px"><%=obox.get("edu_org_nm")%></td>
					<td width="15%" align="center" class="table01_title">기관연락처</td>
					<td width="35%" style="padding-left:5px"><%=obox.get("edu_org_tel")%></td>
				</tr>
				<tr height="28">
					<td align="center" class="table01_title">교육명</td>
					<td style="padding-left:5px"><%=obox.get("course_nm")%></td>
					<td align="center" class="table01_title">교육비</td>
					<td style="padding-left:5px"><%=obox.get("use_amt",Box.THOUSAND_COMMA)%> 원</td>
				</tr>
				<tr height="28">
					<td align="center" class="table01_title">교육일자</td>
					<td colspan="3" style="padding-left:5px"><%=obox.get("start_ymd",Box.DEF_DATE_FMT)%><%if(!obox.get("end_ymd").equals(obox.get("start_ymd"))){%> ~ <%=obox.get("end_ymd",Box.DEF_DATE_FMT)%><%}%>&nbsp;&nbsp;(교육일수 : <%=obox.get("edu_ilsu")%> 일)</td>
				</tr>
				<tr height="28"> 
					<td align="center" class="table01_title">기관주소</td>
					<td colspan="3" style="padding-left:5px"><%=obox.get("edu_org_addr")%></td>
				</tr>
				<tr height="28">
	...
	<tr>
		...
		<% } %>
			<a href="javascript:goUbiViewer('welfare/<%=box.get("dbo")%>/report/s004.jrf', 'P_PARAM01!SLP002,<%=box.get("apply_no")%>!P_PARAM02!ACCTB_SLIP01|<%=obox.get("slip_no")%>|<%=obox.get("apply_no")%>|<%=obox.get("bugt_cd")%>,<%=obox.get("bugt_cd")%>!');"><img src="/com/img/bn_print.gif" border="0" align="absmiddle" alt="인쇄"></a>
		</td>
	</tr>
</table>
</form>
