			...
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
		  		<tr height="28">
					...
					<td style="padding-left:5px">
						<select name="std_yy" title="기준년도" style="width:100px" onChange="go_search('N')">
					...
					<td style="padding-left:5px">
						<input type="text" name="search_val" value="<%=box.get("search_val")%>" style="width:150px;border:1 solid gray;ime-mode:active;" onkeydown="if(event.keyCode == 13) go_search();">
					</td>
				    <td align="center">
			  			<a href="javascript:go_search('N');"><img src="/com/img/btn_search.gif" border="0" align="absmiddle"></a>&nbsp;
			  			<a href="javascript:go_search('E');"><img src="/com/img/btn_excel.gif" border="0" align="absmiddle"></a>
				    </td>
		  		</tr>
			</table>		    
