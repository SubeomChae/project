...
<script language='javascript'>
	function goWelfareView(apply_no, bugt_cd) {
		...
		window.open('wel10.do?method=wel01002_select&apply_no='+apply_no+'&bugt_cd='+bugt_cd+'&popup_yn=Y', 'wel01002', 'width='+wdt+',height='+hgt+',menubar=no,toolbar=no,scrollbars=yes,resizable=no,left='+xPos+',top='+yPos);
	}
</script>
...
<script language="javascript">
	document.getElementById("divArea").style.height = document.body.clientHeight - 5 - <%=rsWp.getLength() > 0 ? "30" : "0"%>;
</script>
