...
<%	String bank_cd = "|bank_cd@@@@A|";
	RsWrapper codeWp = CodeUtil.getRsWrapper("PR_COMTB_CODE02_LIST","MULTCODE", "", "school_flag"+bank_cd,"","","","","");
...
<%@ include file="/WEB-INF/jsp/welfare/payGuide.jsp" %>
	...
	<table class="table table-view table-bordered table-cover marB5">
		<tr>
			<th>학교명</th>
			<td colspan="3">
				<input type="text" name="school_nm" value="<%=obox.get("school_nm")%>" size="10" maxlength="30" title="학교명" class="form-control required" style="width:100px">
		...
		<tr>	
			<th>전공</th>
			<td>
				<input type="text" name="major_nm" value="<%=obox.get("major_nm")%>" size="20" maxlength="20" title="전공" class="form-control" style="width:140px">
			</td>
			<th>자녀명</th>
			<td>
				<input type="text" name="family_nm" value="<%=obox.get("family_nm")%>" size="10" maxlength="20" title="자녀명" class="form-control" style="width:80px">
			</td>
		</tr>
		<tr>
			<th width="15%">신청일자</th>
			...
			<th width="15%">신청금액</th>
			<td width="35%">
				<input type="text" name="apply_amt" value="<%=obox.get("apply_amt")%>" size="13" maxlength="10" title="신청금액" class="form-control required tMONEY" style="width:80px;" > 원
			</td>
		</tr>
		<tr>
			<th>계좌번호</th>
			<td colspan="3">
				...
				<input type="text" name="account_no" value="<%=obox.get("account_no")%>" size="18" maxlength="30" title="계좌번호" class="form-control required" style="width:100px">
				&nbsp;예금주 : <input type="text" name="account_owner" value="<%=obox.get("account_owner")%>" size="10" maxlength="15" title="예금주" class="form-control required" style="width:100px">
			</td>
		</tr>
		<tr>
			<th>비고</th>
