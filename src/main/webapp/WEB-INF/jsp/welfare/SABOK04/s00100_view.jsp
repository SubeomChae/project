...
<table width="100%" border="0" cellspacing="0" bgcolor="#ffffff">
		...
		<td valign="top">
			<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table01">
				<tr height="28">
					...
					<td width="35%" style="padding-left:5px"><%=obox.get("cong_class_nm")%></td>
				...
				<tr height="28">
					...
					<td colspan="3" style="padding-left:5px"><%=obox.get("start_ymd",Box.DEF_DATE_FMT)%><%if(!obox.get("end_ymd").equals(obox.get("start_ymd"))){%> ~ <%=obox.get("end_ymd",Box.DEF_DATE_FMT)%><%}%></td>
				</tr>
				<tr height="28"> 
					<td align="center" class="table01_title">경조장소</td>
					<td colspan="3" style="padding-left:5px"><%=obox.get("cong_place")%></td>
				</tr>
				<tr height="28">
	...
	<tr>
		...
		<% } %>
			<a href="javascript:go_ubi_viewer('welfare/<%=box.get("dbo")%>/report/s001.jrf', 'P_PARAM01!SLP002,<%=box.get("apply_no")%>!P_PARAM02!ACCTB_SLIP01|<%=obox.get("slip_no")%>|<%=obox.get("apply_no")%>|<%=obox.get("bugt_cd")%>,<%=obox.get("bugt_cd")%>!');"><img src="/com/img/bn_print.gif" border="0" align="absmiddle" alt="인쇄"></a>
		</td>
	</tr>
</table>
</form>
