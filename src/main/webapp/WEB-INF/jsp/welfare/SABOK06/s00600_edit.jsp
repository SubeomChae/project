...
<%@ include file="/WEB-INF/jsp/welfare/payGuide.jsp" %>
	...
	<table class="table table-view table-bordered table-cover marB5">
		...
		<tr>
			<th>장소</th>
			<td colspan="3">
				<input type="text" name="event_place" value="<%=obox.get("event_place")%>" size="40" maxlength="50" title="장소" class="form-control required" style=width:300px;ime-mode:active;">
			</td>
		</tr>
		<tr height="100">
			<th>행사내용</th>
