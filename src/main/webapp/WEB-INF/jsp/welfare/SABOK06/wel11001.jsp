	  		...
	  		<tr>
				...
				<% if(box.get("action_type").equals("edit")) { %>
					<div class="input-group input-medium date date-picker" data-date="" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
						<input type="text" name="pay_ymd" value="<%=obox.get("pay_ymd").equals("")?DateUtil.toString("yyyyMMdd"):obox.get("pay_ymd")%>" maxlength="8" title="지급일자" class="form-control required tYMD">
		...
		<% if(obox.getInt("member_cnt") > 0) { %>
			<tr>
				...
				<% }else { %>
					...
					<% } %>
					<% if(obox.get("sign_status").equals("2") || obox.get("sign_status").equals("4")) { %>
