...
<script language="javascript">
	...
	function goCancel() {
		removeMask("#saveForm");
		document.saveForm.action = 'method=wel01002_select.do';
...
<%@ include file="/WEB-INF/jsp/welfare/payGuide.jsp" %>
	...
	<table class="table table-view table-bordered table-cover marB5">
		...
		<tr>	
			<th width="15%">학과</th>
			<td width="35%">
				<input type="text" name="major_nm" value="<%=obox.get("major_nm")%>" size="20" maxlength="20" title="학과" class="form-control" style="width:100px">
			</td>
			<th width="15%">대상자</th>
			<td width="35%">
			<% if(uSesEnt.dbo.equals("SABOK26")) { %>
				<select name="family_rel_cd" title="가족관계" class="bs-select form-control required" style="width:70px;">
