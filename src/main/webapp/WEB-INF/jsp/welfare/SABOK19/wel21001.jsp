	...
	function changeBugtCd(bugt_cd) {
		...
		if(bugt_cd == 'S001') {
			...
			cHtml = "<b>세부사업명</b> : "
				  ...
				  + "<option value=''>전체</option><%=CodeUtil.optList("PR_BUDTB_CODE01_LIST","LISTCODE","","2","S70000","","","",uSesEnt.dbo)%></select> ";
			document.main.excel_file_nm.value = '선물지급현황';		
		}else if(bugt_cd == 'S009') {
			cHtml = "";
			document.main.excel_file_nm.value = '자녀양육비';
		}else if(bugt_cd == 'S019') {
			cHtml = "";
			document.main.excel_file_nm.value = '근속수당';
		}else if(bugt_cd == '') {
			cHtml = "";
