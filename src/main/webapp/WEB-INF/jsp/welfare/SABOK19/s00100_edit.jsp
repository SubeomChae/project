...
<%@ include file="/WEB-INF/jsp/welfare/payGuide.jsp" %>
	...
	<table class="table table-view table-bordered table-cover marB5">
		<tr>
			<th width="15%">경조구분</th>
			<td width="35%">
				<select name="cong_class" class="bs-select form-control required" title="경조구분" style="width:90px" onChange="autoCongAmt()">
		...
		<tr> 
			<th>경조장소</th>
			<td colspan="3">
				<input type="text" name="cong_place" value="<%=obox.get("cong_place")%>" size="50" maxlength="50" title="경조장소" class="form-control required" style="width:140px">
			</td>
		</tr>
		<tr>
			<th>신청일자</th>
