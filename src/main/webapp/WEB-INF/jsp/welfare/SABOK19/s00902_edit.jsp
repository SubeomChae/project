...
%>
<!-- <%if(uSesEnt.dbo.equals("SABOK19")){%>자녀양육비<%}else{%>유아자녀교육비<%}%> 신청서 작성 -->
	...
	<table class="table table-view table-bordered table-cover marB5">	
		<tr>
			...
			<td colspan="4" width="35%">
				<select name="family_id" class="bs-select form-control required" title="대상자 선택" onChange="changeFamilyId(this.value)">
		...
		<tr>
			<th>계좌번호</th>
			<td colspan="3">
				<select name="bank_cd" title="금융기관" class="bs-select form-contorl required" style="width:120px">
