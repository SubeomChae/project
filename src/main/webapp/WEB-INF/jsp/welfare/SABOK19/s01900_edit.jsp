...
<%@ include file="/WEB-INF/jsp/welfare/payGuide.jsp" %>
	...
	<table class="table table-view table-bordered table-cover marB5">	
		...
		<tr>
			...
			<th>신청금액</th>
			<td>
				<input type="text" name="apply_amt" value="<%=obox.get("apply_amt")%>" size="13" maxlength="10" class="required tMONEY" title="신청금액" class="form-control required" style="width:90px" > 원
			</td>
		</tr>
		<tr>
			<th>계좌번호</th>
