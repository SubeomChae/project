	...
	function changeBugtCd(bugt_cd) {
		...
		if(bugt_cd == 'S001') {
			...
			cHtml = "<select name='detail_key' class='bs-select form-control' style='width:90px'>"
				  ...
				  + "<input type='text' name='detail_val' value='' class='bs-select form-control' style='width:150px;ime-mode:active;' onkeydown=\"if(event.keyCode == 13) goSearch('N');\">";
...
<% } %>
	<div class="table-top-control form-inline">
		<div class="notice-view">
	  		<span style="color:#01a1db;">성명을 클릭</span>하면 해당 사원의 <span id="divText"></span>&nbsp;조회할 수 있습니다.</td>
	  	</div>
		<span class="f-right">
