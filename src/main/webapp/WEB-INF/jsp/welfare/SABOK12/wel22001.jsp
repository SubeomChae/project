			...
			<% }else {
					...
					<tr> 
			   	   <% } %>
						...
						<td class="t-center"><%if(!box.get("excel_yn").equals("Y") && !rsWp.get("empl_nm",i).equals("합계")){%><a href="javascript:go_employee_info('<%=rsWp.get("empl_no",i)%>')"><%}%><%=rsWp.get("empl_nm",i)%></a></td>
