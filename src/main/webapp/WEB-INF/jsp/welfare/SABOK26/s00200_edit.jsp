	...
	<table class="table table-view table-bordered table-cover marB5">
		<tr>
			...
			<% if(uSesEnt.dbo.equals("SABOK26")) { %>
		        ...
		        <input type="text" name="family_nm" title="성명" value="<%=obox.get("family_nm")%>" class="form-control required" style="width:120px">
		...
		<tr>
			...
			<td>
				<div class="input-group input-medium date date-picker" data-date="" data-date-format="yyyy-mm-dd" data-date-viewmode="years">
					<input type="text" name="medi_ymd" value="<%=obox.get("medi_ymd")%>" maxlength="8" title="진료일자" class="form-control tYMD">
		...
		<% } %>
			<th>사용금액</th>
			<td>
				<input type="text" name="use_amt" value="<%=obox.get("use_amt")%>" size="8" maxlength="10" class="form-control tMONEY" title="사용금액" style="width:70px;" >&nbsp;원
			</td>
		</tr>
		<tr>
