...
<%	String bank_cd;
	...
	RsWrapper codeWp = CodeUtil.getRsWrapper("PR_COMTB_CODE02_LIST","MULTCODE", "", "continu_class|cong_class@"+uSesEnt.dbo+bank_cd,"","","","","");
...
<%@ include file="/WEB-INF/jsp/welfare/payGuide.jsp" %>
	...
	<table class="table table-view table-bordered table-cover marB5">
		<tr height="28">
			<th>장기근속 구분</td>
			<td colspan="3">
				<select name="continu_class" class="bs-select form-control required"  title="장기근속 구분" style="width:150px">
					<option value=''>:: 장기근속 구분 ::</option>
		            <%=CodeUtil.optList(codeWp, "continu_class", obox.get("continu_class"))%>
				</select>
			</td>
		</tr>
		<tr>
