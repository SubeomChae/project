...
<%	String apply_no = box.get("params");
	Box obox = CodeHelper.getRsBox("PR_REPORT_SQL", "WEL01001", apply_no, "S019","","","",request);
	...
	Paragraph title = new Paragraph("장기근속자 신청서", font_title);
	...
	table.addCell(PdfUtil.cellFormat("근속구분", font_head, "", "", "LIGHT_GRAY", "m25", ""));
	table.addCell(PdfUtil.cellFormat(obox.get("continu_class"), font_data, "LEFT", "", "", "m25", "0,5,0,5", "col3"));
	...
	table.addCell(PdfUtil.cellFormat(obox.get("apply_amt",Box.THOUSAND_COMMA)+"원", font_data, "LEFT", "", "", "m25", "0,5,0,5", "col3"));
