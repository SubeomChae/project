...
<%	String bank_cd;
	...
	RsWrapper codeWp = CodeUtil.getRsWrapper("PR_COMTB_CODE02_LIST","MULTCODE", "", "inspect_class"+bank_cd,"","","","");
...
<script language="javascript">
	function goSave() {
		if (formValidate("#main")) {
			if(confirm('저장하시겠습니까?')) {
				removeMask("#main");
				document.main.data01.value = document.main.area_nm.value;
				document.main.data02.value = document.main.agent_nm.value;
				document.main.data03.value = document.main.start_ymd.value;
				document.main.data04.value = document.main.end_ymd.value;
				document.main.data05.value = document.main.use_ilsu.value;
				document.main.data06.value = document.main.inspect_class.value;
				document.main.data15.value = document.main.support_amt.value;
				document.main.apply_amt.value = document.main.support_amt.value
	...
	<table class="table table-view table-bordered table-cover marB5">
		<tr>
			...
			<td colspan="3" style="padding-left:5px">
				<select name="inspect_class" title="시찰구분" class="required" style="width:120px">
					<option value=''>:: 시찰구분 ::</option>
		            <%=CodeUtil.optList(codeWp, "inspect_class", obox.get("inspect_class"))%>
				</select>
			</td>
		</tr>
		<tr>
