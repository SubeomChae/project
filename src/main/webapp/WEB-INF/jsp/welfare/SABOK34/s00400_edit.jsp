...
<%@ include file="/WEB-INF/jsp/welfare/payGuide.jsp" %>
	...
	<table class="table table-view table-bordered table-cover marB5">
		<tr>
			<th>교육명</th>
			<td>
				<input type="text" name="course_nm" value="<%=obox.get("course_nm")%>" size="30" maxlength="50" title="교육명" class="form-control required" style="width:240px">
			</td>
			<th>교육비</th>
			<td>
		...
		<tr>
			<th width="15%">교육기관</th>
			<td width="35%">
				<input type="text" name="edu_org_nm" value="<%=obox.get("edu_org_nm")%>" size="30" maxlength="50" title="교육기관" class="form-control required" style="width:240px">
			</td>
			...
			<td width="35%">
				...
				<input type="text" name="edu_org_tel2" value="<%=StringUtil.arrayCol(obox.get("edu_org_tel"),2,"-")%>" size="4" maxlength="4" title="전화번호" class="form-control autoTab" style="width:65px"> - 
				<input type="text" name="edu_org_tel3" value="<%=StringUtil.arrayCol(obox.get("edu_org_tel"),3,"-")%>" size="4" maxlength="4" title="전화번호" class="form-control autoTab" style="width:65px">
			</td>
		</tr>
		<tr> 
			<th>기관주소</th>
			<td colspan="3"><input type="text" name="edu_org_addr" value="<%=obox.get("edu_org_addr")%>" size="50" maxlength="50" title="기관주소" class="form-control required" style="width:400px"></td>
		</tr>
		<tr>
			<th>신청일자</th>
			<td>
