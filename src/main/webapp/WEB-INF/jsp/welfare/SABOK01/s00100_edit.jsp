...
<%	} %>
	...
	function autoCongAmt(cong_class) {
	...
	<div class="table-scrollable">
		<table class="table table-view table-bordered">
			<tr>
				<th width="15%">경조구분</th>
				<td width="35%">
					<select name="cong_class" title="경조구분" class="bs-select form-control required" style="width:117px" onChange="autoCongAmt(this.value)">
