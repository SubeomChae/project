...
<table class="search-panel table table-bordered">
	<tr> 
		<td style="border:none">
			<div id="divChart3" style="overflow-x:hidden;overflow-y:hidden;"></div>
			...
			<%  String fields = ""; int colLength = 0; float maxValue = 0; 
				...
				var options = {
			        ...
			        'chartDiv': 'divChart3', 'chartType': 'line', 'chartSize': { width: 1150, height: 500 },
