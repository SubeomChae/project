    ...
    var handleSidebarAndContentHeight = function () {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            ...
            if (content.height() < available_height) {
				...
				map.css('min-height', available_height);
				reading.css('min-height', available_height);
            }
        } else {
            if (body.hasClass('page-sidebar-fixed')) {
                ...
                var pageSubVisual = $('.page-sub-visual').outerHeight();

                if (App.getViewPort().width < resBreakpointMd) {
                    height = App.getViewPort().height - headerHeight - footerHeight - pageSubVisual;
                } else {
                    height = sidebar.height() + 20;
                }

                if ((height + headerHeight + footerHeight + pageSubVisual) <= App.getViewPort().height) {
                    height = App.getViewPort().height - headerHeight - footerHeight - pageSubVisual;
                }
            }
            content.css('min-height', height);
			map.css('min-height', height);
			reading.css('min-height', height);
        }
    };
