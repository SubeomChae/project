...
THREE.TransformControls = function ( camera, domElement ) {
	...
	this.updateMatrixWorld = function () {
		...
		if ( this.object !== undefined ) {
			if(this.object.parent == null)return; //minki
	...
	this.pointerDown = function( pointer ) {
		...
		if ( ( pointer.button === 0 || pointer.button === undefined ) && this.axis !== null ) {
			...
			if ( planeIntersect ) {
				...
				this.object.updateMatrixWorld();
				if(this.object.parent != null){ //minki
	...
	this.pointerMove = function( pointer ) {
		...
		if ( mode === 'translate' ) {
			...
			try{
				...
				var offsetPt = {
					x : this.bujePosition.x + object.position.x,
					y : this.bujePosition.y + object.position.y,
					z : this.bujePosition.z + object.position.z
				};
				console.log('offsetPt', offsetPt);
				moveAsTransformControls(offsetPt);
			}catch(e){
			}
